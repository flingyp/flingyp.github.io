import{_ as s,c as a,o as i,V as n}from"./chunks/framework.DgbPds4s.js";const g=JSON.parse('{"title":"笔记","description":"","frontmatter":{},"headers":[],"relativePath":"backend/Docker/笔记.md","filePath":"backend/Docker/笔记.md","lastUpdated":1731573950000}'),p={name:"backend/Docker/笔记.md"},l=n(`<h1 id="笔记" tabindex="-1">笔记 <a class="header-anchor" href="#笔记" aria-label="Permalink to &quot;笔记&quot;">​</a></h1><h2 id="部署一个-vue3-项目" tabindex="-1">部署一个 Vue3 项目 <a class="header-anchor" href="#部署一个-vue3-项目" aria-label="Permalink to &quot;部署一个 Vue3 项目&quot;">​</a></h2><p>在你的项目根目录下创建一个 <code>dockerfile</code> 文件，用来定义 Docker 镜像的构建规则。</p><div class="language-dockerfile vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dockerfile</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 使用 Node.js 16 作为基础镜像</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">yarn-error.log*</span></span></code></pre></div><p>最后使用 <code>docker run -d -p 9999:80 镜像名称</code> 来运行容器，其中 <code>-p 9999:80</code> 表示将宿主机的 9999 端口映射到容器的 80 端口，<code>镜像名称</code> 是你前面构建的镜像的名称。</p><h2 id="部署一个-nuxt3-项目" tabindex="-1">部署一个 Nuxt3 项目 <a class="header-anchor" href="#部署一个-nuxt3-项目" aria-label="Permalink to &quot;部署一个 Nuxt3 项目&quot;">​</a></h2><p>在你的项目根目录下创建一个 <code>dockerfile</code> 文件，用来定义 Docker 镜像的构建规则。</p><div class="language-dockerfile vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">dockerfile</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 使用 Node.js 作为基础镜像</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">README.md</span></span></code></pre></div><p>最后使用 <code>docker run -d -p 9999:3000 镜像名称</code> 来运行容器，其中 <code>-p 9999:3000</code> 表示将宿主机的 9999 端口映射到容器的 3000 端口，<code>镜像名称</code> 是你前面构建的镜像的名称。</p>`,15),e=[l];function t(h,k,d,c,o,r){return i(),a("div",null,e)}const y=s(p,[["render",t]]);export{g as __pageData,y as default};
