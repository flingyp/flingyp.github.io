import{_ as s,c as a,o as e,as as p}from"./chunks/framework.B-x_5eXW.js";const g=JSON.parse('{"title":"Nginx 基本使用","description":"","frontmatter":{},"headers":[],"relativePath":"backend/Nginx.md","filePath":"backend/Nginx.md","lastUpdated":1764299517000}'),l={name:"backend/Nginx.md"};function i(t,n,c,o,r,d){return e(),a("div",null,n[0]||(n[0]=[p(`<h1 id="nginx-基本使用" tabindex="-1">Nginx 基本使用 <a class="header-anchor" href="#nginx-基本使用" aria-label="Permalink to &quot;Nginx 基本使用&quot;">​</a></h1><h2 id="安装" tabindex="-1">安装 <a class="header-anchor" href="#安装" aria-label="Permalink to &quot;安装&quot;">​</a></h2><ol><li>基于 Yum 的 方式安装 Nginx</li></ol><p>先来查看 yum 是否存在 <code>yum list | grep nginx</code> 如果存在并且系统的 nginx 源 也存在，但是版本有些低。我们可以自己配置 yum 源</p><div class="language-nginx vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">nginx</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">[nginx]</span></span>
