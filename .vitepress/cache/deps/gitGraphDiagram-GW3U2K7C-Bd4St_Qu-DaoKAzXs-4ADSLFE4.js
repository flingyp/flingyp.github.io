...
// node_modules/.pnpm/vitepress-plugin-legend@1.0.4_jiti@1.21.7_markmap-common@0.18.9_typescript@5.4.3_yaml@2.8.0/node_modules/vitepress-plugin-legend/dist/gitGraphDiagram-GW3U2K7C-Bd4St_Qu-DaoKAzXs.js
var x = {
  NORMAL: 0,
  REVERSE: 1,
  HIGHLIGHT: 2,
...
var gt = S(function(r) {
  ...
  const o = P();
  a = ga.sanitizeText(a, o), t = ga.sanitizeText(t, o), e2 = e2 == null ? void 0 : e2.map((c) => ga.sanitizeText(c, o));
  const d = {
...
var yt = S(function(r) {
  let t = r.name;
  const a = r.order;
  if (t = ga.sanitizeText(t, P()), s.records.branches.has(t))
    throw new Error(
      `Trying to create an existing branch. (Help: Either use a new name if you want create a new branch or try using "checkout ${t}")`
    );
  s.records.branches.set(t, s.records.head != null ? s.records.head.id : null), s.records.branchConfig.set(t, { name: t, order: a }), N(t), ut.debug("in createBranch");
}, "branch");
var pt = S((r) => {
  let t = r.branch, a = r.id;
  const n = r.type, e2 = r.tags, o = P();
  t = ga.sanitizeText(t, o), a && (a = ga.sanitizeText(a, o));
...
var xt = S(function(r) {
  ...
  const o = P();
  if (t = ga.sanitizeText(t, o), a = ga.sanitizeText(a, o), n = n == null ? void 0 : n.map((l) => ga.sanitizeText(l, o)), e2 = ga.sanitizeText(e2, o), !t || !s.records.commits.has(t)) {
    const l = new Error(
...
var N = S(function(r) {
  if (r = ga.sanitizeText(r, P()), s.records.branches.has(r)) {
...
var Tt = S((r, t) => {
  const a = {
    Commit: S((n) => t.commit(Mt(n)), "Commit"),
    Branch: S((n) => t.branch(vt(n)), "Branch"),
    Merge: S((n) => t.merge(Pt(n)), "Merge"),
    Checkout: S((n) => t.checkout(Rt(n)), "Checkout"),
    CherryPicking: S((n) => t.cherryPick(Gt(n)), "CherryPicking")
  }[r.$type];
...
var Rt = S((r) => r.branch, "parseCheckout");
var Gt = S((r) => {
  var _a;
  return {
    id: r.id,
...
var At = me();
var B = At == null ? void 0 : At.gitGraph;
var T = 10;
var M = 40;
var k = 4;
var C = 2;
...
var y = "LR";
var Ot = S(() => {
  b.clear(), w.clear(), R.clear(), L = 0, A = [], y = "LR";
}, "clear");
var K = S((r) => {
...
var F = S((r) => {
  let t, a, n;
  return y === "BT" ? (a = S((e2, o) => e2 <= o, "comparisonFunc"), n = 1 / 0) : (a = S((e2, o) => e2 >= o, "comparisonFunc"), n = 0), r.forEach((e2) => {
    var _a, _b;
...
var St = S((r) => zt(r) + M, "calculateCommitPosition");
var Dt = S((r, t) => {
...
var S2 = S((r, t, a) => {
  ...
  let o = y === "TB" || y === "BT" ? I : 0;
  const d = [...t.keys()], c = (B == null ? void 0 : B.parallelCommits) ?? false, l = S((m, g) => {
    var _a, _b;
  ...
  y === "BT" && (c && Ht($, t, o), $ = $.reverse()), $.forEach((m) => {
    ...
    if (a) {
      ...
      Wt(n, g, i2, f, q, p), jt(e2, g, i2, o), Kt(e2, g, i2, o);
    }
    y === "TB" || y === "BT" ? w.set(g.id, { x: i2.x, y: i2.posWithOffset }) : w.set(g.id, { x: i2.posWithOffset, y: i2.y }), o = y === "BT" && c ? o + M : o + M + T, o > L && (L = o);
  });
}, "drawCommits");
var Ut = S((r, t, a, n, e2) => {
  const o = (y === "TB" || y === "BT" ? a.x < n.x : a.y < n.y) ? t.branch : r.branch, d = S((l) => l.branch === o, "isOnBranchToGetCurve"), c = S((l) => l.seq > r.seq && l.seq < t.seq, "isBetweenCommits");
...
var G = S((r, t, a = 0) => {
  ...
  if (a > 5)
    return n;
  if (A.every((o) => Math.abs(o - n) >= 10))
    return A.push(n), n;
  const e2 = Math.abs(r - t);
  return G(r, t - e2 / 5, a + 1);
}, "findLane");
var Vt = S((r, t, a, n) => {
  var _a, _b, _c, _d, _e;
  ...
  if (d) {
    ...
    const f = e2.y < o.y ? G(e2.y, o.y) : G(o.y, e2.y), p = e2.x < o.x ? G(e2.x, o.x) : G(o.x, e2.x);
...
var Xt = S((r, t) => {
  ...
  t.forEach((n, e2) => {
    ...
    c.attr("x1", 0), c.attr("y1", d), c.attr("x2", L), c.attr("y2", d), c.attr("class", "branch branch" + o), y === "TB" ? (c.attr("y1", I), c.attr("x1", d), c.attr("y2", L), c.attr("x2", d)) : y === "BT" && (c.attr("y1", L), c.attr("x1", d), c.attr("y2", I), c.attr("x2", d)), A.push(d);
    const l = n.name, $ = K(l), m = a.insert("rect"), g = a.insert("g").attr("class", "branchLabel").insert("g").attr("class", "label branch-label" + o);
    g.node().appendChild($);
    const i2 = $.getBBox();
...
`, "id:", t, a), !B)
  ...
  d.forEach(($, m) => {
    var _a;
    const g = K($.name), i2 = c.append("g"), f = i2.insert("g").attr("class", "branchLabel"), p = f.insert("g").attr("class", "label branch-label");
    (_a = p.node()) == null ? void 0 : _a.appendChild(g);
    const q = g.getBBox();
    l = Qt($.name, l, m, q, e2), p.remove(), f.remove(), i2.remove();
  }), S2(c, R, false), B.showBranches && Xt(c, d), Jt(c, R), S2(c, R, true), Xn.insertTitle(
    c,
    "gitTitleText",
    B.titleTopMargin ?? 0,
    o.getDiagramTitle()
...
//# sourceMappingURL=gitGraphDiagram-GW3U2K7C-Bd4St_Qu-DaoKAzXs-4ADSLFE4.js.map
