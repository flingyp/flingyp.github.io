...
// node_modules/.pnpm/vitepress-plugin-legend@1.0.2_jiti@1.21.7_markmap-common@0.18.9_typescript@5.4.3_yaml@2.7.0/node_modules/vitepress-plugin-legend/dist/layout-Cs5ikrrM-CuMGFjvC.js
function Un(n) {
  return oX(tX(n, void 0, er), n + "");
}
var Zn = 1;
var Wn = 4;
function Xn(n) {
...
function T(n, r) {
  var e = {};
  return r = $r(r), ia(n, function(t, o, i) {
    Zm(e, o, r(t, o, i));
  }), e;
}
function y2(n) {
  return n && n.length ? ar(n, zk, er2) : void 0;
}
function H(n, r) {
  return n && n.length ? ar(n, $r(r), tr) : void 0;
}
function tr2(n, r) {
  var e = n.length;
  for (n.sort(r); e--; )
...
function fr2(n) {
  return function(r, e, t) {
    return t && typeof t != "number" && cX(r, e, t) && (e = t = void 0), r = R(r), e === void 0 ? (e = r, r = 0) : e = R(e), t = t === void 0 ? r < e ? 1 : -1 : R(t), sr2(r, e, t);
  };
}
var E = fr2();
var R2 = lX(function(n, r) {
  if (n == null)
    return [];
  var e = r.length;
  return e > 1 && cX(n, r[0], r[1]) ? r = [] : e > 2 && cX(r[0], r[1], r[2]) && (r = [r[0]]), ar2(n, wa(r), []);
});
var hr = 0;
function Q(n) {
  var r = ++hr;
...
function Or(n) {
  ...
  _a(e, function(i, a) {
    ma(i) && a % o !== 0 ? --t : t && _a(i, function(u) {
      n.node(u).rank += t;
    });
  });
}
function tn(n, r, e, t) {
  ...
  return arguments.length >= 4 && (o.rank = e, o.order = t), _(n, "border", o, r);
}
function bn(n) {
  return y2(
...
function on(n, r, e, t, o, i) {
  var a = { width: 0, height: 0, rank: i, borderType: r }, u = o[r][i - 1], d = _(n, "border", a, e);
...
function Mr(n) {
  _a(n.nodes(), function(r) {
    ...
    var e = n.edge(r);
    _a(e.points, B), Object.prototype.hasOwnProperty.call(e, "y") && B(e);
  });
}
function B(n) {
  n.y = -n.y;
  ...
  if (i !== t + 1) {
    ...
    for (h = 0, ++t; t < i; ++h, ++t)
      u.points = [], c = {
        ...
        edgeObj: r,
        rank: t
      }, f = _(n, "edge", c, "_d"), t === d && (c.width = u.width, c.height = u.height, c.dummy = "edge-label", c.labelpos = u.labelpos), n.setEdge(e, f, { weight: u.weight }, a), h === 0 && n.graph().dummyChains.push(f), e = f;
...
function xn(n) {
  ...
  for (var o, i; Fr(r, n) < t; )
    o = Vr(r, n), i = r.hasNode(o.v) ? P2(n, o) : -P2(n, o), Br(r, n, i);
  return r;
}
function Fr(n, r) {
  function e(t) {
...
function W(n, r) {
  arguments.length < 2 && (r = n.nodes()[0]), _n(n, {}, 1, r);
}
function _n(n, r, e, t, o) {
  var i = e, a = n.node(t);
  return r[t] = true, _a(n.neighbors(t), function(u) {
    Object.prototype.hasOwnProperty.call(r, u) || (e = _n(n, r, e, u, t));
...
function Hr(n) {
  var r = _(n, "root", {}, "_root"), e = Qr(n), t = y2(Oa(e)) - 1, o = 2 * t + 1;
...
function Ln(n, r, e, t, o, i, a) {
  ...
  n.setParent(d, a), f.borderTop = d, n.setParent(c, a), f.borderBottom = c, _a(u, function(h) {
    Ln(n, r, e, t, o, i, h);
    var g = n.node(h), v = g.borderTop ? g.borderTop : h, l = g.borderBottom ? g.borderBottom : h, w = g.borderTop ? t : 2 * t, O = v !== l ? 1 : o - i[a] + 1;
    n.setEdge(d, v, {
      weight: w,
      minlen: O,
      nestingEdge: true
...
function Xr(n, r, e) {
  ...
  return _a(n.nodes(), function(i) {
    ...
    (a.rank === r || a.minRank <= r && r <= a.maxRank) && (o.setNode(i), o.setParent(i, u || t), _a(n[e](i), function(d) {
      var c = d.v === i ? d.w : d.v, f = o.edge(c, i), h = ma(f) ? 0 : f.weight;
...
function ie(n, r) {
  ...
  _a(n, function(o, i) {
    ...
    ma(o.barycenter) || (a.barycenter = o.barycenter, a.weight = o.weight);
  }), _a(r.edges(), function(o) {
    var i = e[o.v], a = e[o.w];
    !ma(i) && !ma(a) && (a.indegree++, i.out.push(e[o.w]));
  });
...
function ae(n) {
  ...
  function e(i) {
    return function(a) {
      a.merged || (ma(a.barycenter) || ma(i.barycenter) || a.barycenter >= i.barycenter) && ue(i, a);
    };
  }
  function t(i) {
    return function(a) {
...
function fe(n, r) {
  ma(n.barycenter) ? (n.barycenter = r.barycenter, n.weight = r.weight) : (n.barycenter = (n.barycenter * n.weight + r.barycenter * r.weight) / (n.weight + r.weight), n.weight += r.weight);
}
function he(n) {
    ...
    return _a(i, function(f, h) {
      ...
      (g || f === c) && (_a(i.slice(u, h + 1), function(l) {
        _a(n.predecessors(l), function(w) {
          var O = n.node(w), X = O.order;
          (X < a || v < X) && !(O.dummy && n.node(l).dummy) && Cn(e, w, l);
        });
      }), u = h + 1, a = v);
    }), i;
  }
...
function Ie(n) {
  var r = $(n), e = uX(we(n, r), me(n, r)), t = {}, o;
  _a(["u", "d"], function(a) {
    o = a === "u" ? r : Oa(r).reverse(), _a(["l", "r"], function(u) {
  ...
  var i = Ne(n, t);
  return _e(t, i), Oe(t, n.graph().align);
}
function Pe(n, r, e) {
...
var Fe = ["width", "height"];
var Ve = { width: 0, height: 0 };
var Be = ["minlen", "weight", "width", "height", "labeloffset"];
var Ge = {
  minlen: 1,
  weight: 1,
  width: 0,
...
var Ye = ["labelpos"];
function qe(n) {
  var r = new y({ multigraph: true, compound: true }), e = q(n.graph());
  return r.setGraph(
    uX({}, $e, Y(e, Te), M(e, Se))
  ), _a(n.nodes(), function(t) {
    var o = q(n.node(t));
    r.setNode(t, ir(Y(o, Fe), Ve)), r.setParent(t, n.parent(t));
...
//# sourceMappingURL=chunk-HUZG2C34.js.map
