...
// node_modules/.pnpm/vitepress-plugin-legend@1.0.4_jiti@1.21.7_markmap-common@0.18.9_typescript@5.4.3_yaml@2.8.0/node_modules/vitepress-plugin-legend/dist/timeline-definition-MYPXXCX6-BC6DTEXu-Dheq_747.js
var Z = function() {
  var n = S(function(g, i, c, d) {
    ...
    performAction: S(function(g, i, c, d, u, o, m) {
      var k = o.length - 1;
      switch (u) {
        case 1:
          return o[k - 1];
    ...
    parse: S(function(g) {
      var i = this, c = [0], d = [], u = [null], o = [], m = this.table, k = "", N = 0, P = 0, D = 2, C = 1, w = o.slice.call(arguments, 1), x = Object.create(this.lexer), S2 = { yy: {} };
      for (var H in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, H) && (S2.yy[H] = this.yy[H]);
      x.setInput(g, S2.yy), S2.yy.lexer = x, S2.yy.parser = this, typeof x.yylloc > "u" && (x.yylloc = {});
      var L = x.yylloc;
      o.push(L);
      var G = x.options && x.options.ranges;
      typeof S2.yy.parseError == "function" ? this.parseError = S2.yy.parseError : this.parseError = Object.getPrototypeOf(this).parseError;
      function ft(E) {
...
` + this.showPosition(), {
      ...
      performAction: S(function(i, c, d, u) {
        switch (d) {
          case 0:
            break;
          case 1:
  ...
  return S(b, "Parser"), b.prototype = f, f.Parser = b, new b();
}();
Z.parser = Z;
var St = Z;
var it = {};
...
var B = [];
var z = [];
var at = S(() => uw, "getCommonDb");
var ot = S(function() {
  Y.length = 0, B.length = 0, j = "", z.length = 0, hP();
}, "clear");
var ct = S(function(n) {
  j = n, Y.push(n);
}, "addSection");
...
var Nt = S(function(n, t) {
  ...
  return S(h, "ambivalent"), t.score > 3 ? s(a) : t.score < 3 ? l(a) : h(a), e;
}, "drawFace");
var Ct = S(function(n, t) {
...
var gt = function() {
  ...
  return S(a, "_setTextAttrs"), function(s) {
...
var Ot = S(function(n, t, e, a) {
  ...
  return t.height = p.height + f * 1.1 * 0.5 + t.padding, t.height = Math.max(t.height, t.maxHeight), t.width = t.width + 2 * t.padding, y.attr("transform", "translate(" + t.width / 2 + ", " + t.padding / 2 + ")"), zt2(h, t, s, a), t;
}, "drawNode");
var jt = S(function(n, t, e) {
  var _a;
...
var Dt = S(function(n, t, e, a) {
  var _a, _b, _c;
  const s = me(), l = ((_a = s.timeline) == null ? void 0 : _a.leftMargin) ?? 50;
  ...
  for (const [C, w] of f.entries()) {
    const x = {
      ...
      padding: 20,
      maxHeight: i
    }, S2 = M.getVirtualNodeHeight(p, x, s);
    ut.debug("taskHeight before draw", S2), i = Math.max(i, S2 + 20), N = Math.max(N, w.events.length);
    let H = 0;
  ...
  ut.debug("maxSectionHeight before draw", g), ut.debug("maxTaskHeight before draw", i), b && b.length > 0 ? b.forEach((C) => {
    ...
    const S2 = p.append("g"), H = M.drawNode(S2, x, m, s);
    ut.debug("sectionNode output", H), S2.attr("transform", `translate(${u}, ${d})`), o += g + 50, w.length > 0 && st(
      p,
      w,
      m,
      u,
  ...
  ut.debug("bounds", D), _ && p.append("text").text(_).attr("x", D.width / 2 - l).attr("font-size", "4ex").attr("font-weight", "bold").attr("y", 20), c = k ? g + i + 150 : i + 100, p.append("g").attr("class", "lineWrapper").append("line").attr("x1", l).attr("y1", c).attr("x2", D.width + 3 * l).attr("y2", c).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)"), oP(
    void 0,
    p,
...
var st = S(function(n, t, e, a, s, l, h, y, p, f, _) {
  var _a;
  for (const b of t) {
    const g = {
      descr: b.task,
    ...
    a = a + 200, _ && !((_a = h.timeline) == null ? void 0 : _a.disableMulticolor) && e++;
  }
  s = s - 10;
}, "drawTasks");
var Ft = S(function(n, t, e, a, s, l) {
  let h = 0;
  const y = s;
  s = s + 100;
  for (const p of t) {
...
var Rt = S((n) => {
  ...
  for (let e = 0; e < n.THEME_COLOR_LIMIT; e++)
    n["lineColor" + e] = n["lineColor" + e] || n["cScaleInv" + e], hc(n["lineColor" + e]) ? n["lineColor" + e] = At(n["lineColor" + e], 20) : n["lineColor" + e] = zt(n["lineColor" + e], 20);
  for (let e = 0; e < n.THEME_COLOR_LIMIT; e++) {
    const a = "" + (17 - 3 * e);
    t += `
...
//# sourceMappingURL=timeline-definition-MYPXXCX6-BC6DTEXu-Dheq_747-GHWKGYSC.js.map
