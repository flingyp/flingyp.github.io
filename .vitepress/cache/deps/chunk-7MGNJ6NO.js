...
// node_modules/.pnpm/vitepress-plugin-legend@1.0.2_jiti@1.21.7_markmap-common@0.18.9_typescript@5.4.3_yaml@2.7.0/node_modules/vitepress-plugin-legend/dist/mermaid-parser.core-U0GxjMta-Bn5CVAjt.js
var Oc = Object.prototype;
var _c = Oc.hasOwnProperty;
var Ae = hX(function(r, e) {
  if (Du(e) || Fu(e)) {
    RG(e, A(e), r);
    return;
  }
  for (var t in e)
    _c.call(e, t) && qG(r, t, e[t]);
});
function wl(r, e, t) {
  var n2 = -1, i = r.length;
...
function Uc(r, e, t, n2) {
  ...
  if (!o)
    return l;
  e.length >= Fc && (s = mr, a = false, e = new C(e));
  e:
    for (; ++i < o; ) {
      var c = r[i], d = c;
      if (c = c !== 0 ? c : 0, a && d === d) {
...
var jc = Dc(function(r, e, t) {
  Vc.call(r, t) ? r[t].push(e) : Zm(r, t, [e]);
});
var Hc = "[object String]";
function he(r) {
  return typeof r == "string" || !I0(r) && fc(r) && go(r) == Hc;
}
var Wc = Math.max;
function de(r, e, t, n2) {
  r = Fu(r) ? r : Oa(r), t = t ? V(t) : 0;
  var i = r.length;
...
function Me(r, e) {
  ...
  return e = $r(e), pr2(r, t, function(n2, i) {
    return e(n2, i[0]);
  });
}
function Xn(r, e) {
...
function Bs(r) {
  return r && r.length ? Ca(r) : [];
}
function Jc(r, e) {
  return r && r.length ? Ca(r, $r(e)) : [];
}
function ae(r) {
...
var mr2 = "TerminalAlternatives";
function Rd(r) {
  return M.isInstance(r, mr2);
}
...
var Bl = class extends bl {
  getAllTypes() {
    return [zt, Kr2, Vr, ir2, sr2, jr, Hr2, ar, Yt, or, fi, qt, lr2, Xt, ur, Wr, pi, cr2, Qt, Jt, dr, mi, fr2, Zt, zr, Yr, er2, tr, qr2, hr, fn, pr3, rr, Xr, mr2, gr, Ct, yr, nr, gi, Ra, Qr, Tr, vr2, hi, Rr];
  }
            ...
            _a(a.value, (l) => {
              if (typeof l == "number")
                ...
                if (t === true)
                  ...
                  for (let c = u.from; c <= u.to && c < Er; c++)
                    Zr(c, e, t);
                  if (u.to >= Er) {
                    const c = u.from >= Er ? u.from : Er, d = u.to, f = et(c), h = et(d);
                    for (let m = f; m <= h; m++)
                      e[m] = m;
                  }
                }
...
function us(r) {
  ...
  return e && e.atLeast === 0 ? true : r.value ? I0(r.value) ? _e(r.value, us) : us(r.value) : false;
}
...
`],
  ...
  t("misc mapping", () => {
    a = lr(n2, ($) => $.tokenTypeIdx), o = lr(n2, ($) => {
      ...
      const T = $.LONGER_ALT;
      if (T)
        return I0(T) ? lr(T, (I) => ya(n2, I)) : [ya(n2, T)];
...
function $f(r) {
  const e = Aa(r, (i) => {
    const s = i[Tt];
    return !Xe(s) && !Km(s) && !sr(s, "exec") && !he(s);
  }), t = lr(e, (i) => ({
...
function _f(r, e, t) {
  const n2 = [];
  return sr(r, $r2) || n2.push({
    message: "A MultiMode Lexer cannot be initialized without a <" + $r2 + `> property in its definition
`,
...
`,
  ...
  }), sr(r, en) && sr(r, $r2) && !sr(r.modes, r.defaultMode) && n2.push({
    message: `A MultiMode Lexer cannot be initialized with a ${$r2}: <${r.defaultMode}>which does not exist
`,
...
`,
        ...
        const l = I0(a.LONGER_ALT) ? a.LONGER_ALT : [a.LONGER_ALT];
        _a(l, (u) => {
          !ma(u) && !de(i, u) && n2.push({
...
function Pf(r, e, t) {
  const n2 = [];
  let i = false;
  const s = _r(er(Oa(r.modes))), a = Xn(s, (l) => l[Tt] === fe.NA), o = au(t);
  return e && _a(a, (l) => {
    const u = su(l, o);
    if (u !== false) {
      const c = {
...
function Bf(r) {
  ...
  for (; n2; ) {
    ...
    const i = qn(t, e);
    e = e.concat(i), t5(i) ? n2 = false : t = i;
  }
  return e;
}
function Kf(r) {
  _a(r, (e) => {
    uu(e) || (ou[Ca2] = e, e.tokenTypeIdx = Ca2++), Na(e) && !I0(e.CATEGORIES) && (e.CATEGORIES = [e.CATEGORIES]), Na(e) || (e.CATEGORIES = []), Hf(e) || (e.categoryMatches = []), Wf(e) || (e.categoryMatchesMap = {});
  });
}
function Vf(r) {
  _a(r, (e) => {
...
a boolean 2nd argument is no longer supported`);
	...
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#MISSING_LINE_TERM_CHARS`);
        ...
        this.trackStartLines = /full|onlyStart/i.test(this.config.positionTracking), this.trackEndLines = /full/i.test(this.config.positionTracking), I0(e) ? i = {
      ...
      }), this.defaultMode = i.defaultMode, !t5(this.lexerDefinitionErrors) && !this.config.deferDefinitionErrorsHandling) {
...
` + o);
      ...
      _a(this.lexerDefinitionWarning, (o) => {
        ...
        if (nu ? (this.chopInput = zk, this.match = this.matchWithTest) : (this.updateLastIndex = qr, this.match = this.matchWithExec), s && (this.handleModes = qr), this.trackStartLines === false && (this.computeNewColumn = zk), this.trackEndLines === false && (this.updateTokenEndLineColumnLocation = qr), /full/i.test(this.config.positionTracking))
  ...
  tokenize(e, t = this.defaultMode) {
    if (!t5(this.lexerDefinitionErrors)) {
...
` + n2);
  ...
  tokenizeInternal(e, t) {
    let n2, i, s, a, o, l, u, c, d, f, h, m, g, k, R;
    const $ = e, T = $.length;
    let I = 0, G = 0;
    ...
    for (; I < T; ) {
      ...
      for (n2 = 0; n2 < It; n2++) {
        ...
        u = null;
        const Ke = be.short;
        if (Ke !== false ? se === Ke && (l = ve) : be.isCustom === true ? (R = ve.exec($, I, Le, E), R !== null ? (l = R[0], R.payload !== void 0 && (u = R.payload)) : l = null) : (this.updateLastIndex(ve, I), l = this.match(ve, e, I)), l !== null) {
          if (o = be.longerAlt, o !== void 0) {
            const Je = o.length;
            for (s = 0; s < Je; s++) {
              const Ve = O[o[s]], dt = Ve.pattern;
              if (c = null, Ve.isCustom === true ? (R = dt.exec($, I, Le, E), R !== null ? (a = R[0], R.payload !== void 0 && (c = R.payload)) : a = null) : (this.updateLastIndex(dt, I), a = this.match(dt, e, I)), a && a.length > l.length) {
                l = a, u = c, be = Ve;
                break;
              }
            }
      ...
      if (l !== null) {
        ...
        if (g = I - ve, Se2 = this.computeNewColumn(Se2, g), k = this.config.errorMessageProvider.buildUnexpectedCharactersMessage($, ve, g, Ke, Je), ye.push({
          offset: ve,
          line: Ke,
          column: Je,
          length: g,
...
function qf(r) {
  const e = r.pattern, t = {};
  if (t.name = r.name, ma(e) || (t.PATTERN = e), sr(r, Yf))
    throw `The parent property is no longer supported.
See: https://github.com/chevrotain/chevrotain/issues/564#issuecomment-349062346 for details.`;
  return sr(r, wa2) && (t.CATEGORIES = r[wa2]), Ur([t]), sr(r, La) && (t.LABEL = r[La]), sr(r, ba) && (t.GROUP = r[ba]), sr(r, _a2) && (t.POP_MODE = r[_a2]), sr(r, Oa2) && (t.PUSH_MODE = r[Oa2]), sr(r, Pa) && (t.LONGER_ALT = r[Pa]), sr(r, Ma) && (t.LINE_BREAKS = r[Ma]), sr(r, Da) && (t.START_CHARS_HINT = r[Da]), t;
}
...
var Zf = class extends ti {
  ...
  updateExpectedNext() {
    t5(this.ruleStack) ? (this.nextProductionName = "", this.nextProductionOccurrence = 0, this.isAtEndOfPath = true) : (this.nextProductionName = this.ruleStack.pop(), this.nextProductionOccurrence = this.occurrenceStack.pop());
  }
};
    ...
    if (o instanceof re)
      ...
      if (o instanceof ge)
        return _a(o.definition, (l) => {
          t5(l.definition) === false && (n2 = a(l.definition));
        }), n2;
      if (o instanceof F)
...
function hu(r, e, t, n2) {
  ...
  for (d.push({
    ...
    if (R === i) {
      ...
      const $ = n(g);
      $.push(R.nonTerminalName);
      const T = n(k);
      T.push(R.idx);
      const I = {
        idx: m,
        def: R.definition.concat(s, J(h)),
        ruleStack: $,
        occurrenceStack: T
      };
      d.push(I);
      ...
      const $ = new F({
        ...
        definition: [$].concat(R.definition),
        idx: R.idx
      }), I = R.definition.concat([T], J(h)), G = {
        idx: m,
        def: I,
        ruleStack: g,
        occurrenceStack: k
      ...
      const T = new F({
        ...
        definition: [T].concat(R.definition),
        idx: R.idx
      }), G = R.definition.concat([I], J(h)), ie = {
        idx: m,
        def: G,
        ruleStack: g,
        occurrenceStack: k
      ...
      for (let $ = R.definition.length - 1; $ >= 0; $--) {
        const T = R.definition[$], I = {
          idx: m,
...
function oh(r, e, t) {
  ...
  if (n2 && !t) {
    const s = er(r);
    if (s.length === 1 && t5(s[0].categoryMatches)) {
...
function gu(r) {
  return _e(r, (e) => _e(e, (t) => _e(t, (n2) => t5(n2.categoryMatches))));
}
function dh(r) {
...
var bh = class {
  ...
  canRecoverWithSingleTokenInsertion(e, t) {
    if (!this.canTokenTypeBeInsertedInRecovery(e) || t5(t))
      return false;
    const n2 = this.LA(1);
...
function Hh(r, e) {
  const t = Aa(e, (i) => Km(r[i]) === false), n2 = lr(t, (i) => ({
...
var Wh = class {
  initTreeBuilder(e) {
    if (this.CST_STACK = [], this.outputCst = e.outputCst, this.nodeLocationTracking = sr(e, "nodeLocationTracking") ? e.nodeLocationTracking : Qe.nodeLocationTracking, !this.outputCst)
      this.cstInvocationStateUpdate = qr, this.cstFinallyStateUpdate = qr, this.cstPostTerminal = qr, this.cstPostNonTerminal = qr, this.cstPostRule = qr;
    else if (/full/i.test(this.nodeLocationTracking))
      this.recoveryEnabled ? (this.setNodeLocationFromToken = Va, this.setNodeLocationFromNode = Va, this.cstPostRule = qr, this.setInitialNodeLocation = this.setInitialNodeLocationFullRecovery) : (this.setNodeLocationFromToken = qr, this.setNodeLocationFromNode = qr, this.cstPostRule = this.cstPostRuleFull, this.setInitialNodeLocation = this.setInitialNodeLocationFullRegular);
    else if (/onlyOffset/i.test(this.nodeLocationTracking))
      this.recoveryEnabled ? (this.setNodeLocationFromToken = Ka, this.setNodeLocationFromNode = Ka, this.cstPostRule = qr, this.setInitialNodeLocation = this.setInitialNodeLocationOnlyOffsetRecovery) : (this.setNodeLocationFromToken = qr, this.setNodeLocationFromNode = qr, this.cstPostRule = this.cstPostRuleOnlyOffset, this.setInitialNodeLocation = this.setInitialNodeLocationOnlyOffsetRegular);
    else if (/none/i.test(this.nodeLocationTracking))
      this.setNodeLocationFromToken = qr, this.setNodeLocationFromNode = qr, this.cstPostRule = qr, this.setInitialNodeLocation = qr;
    else
  ...
  getBaseCstVisitorConstructor() {
    if (ma(this.baseCstVisitorConstructor)) {
  ...
  getBaseCstVisitorConstructorWithDefaults() {
    if (ma(this.baseCstVisitorWithDefaultsConstructor)) {
...
var Yh = class {
  ...
  getSerializedGastProductions() {
    return rf(Oa(this.gastProductionsCache));
  }
};
var qh = class {
  initRecognizerEngine(e, t) {
    ...
    else if (sr(e, "modes") && _e(er(Oa(e.modes)), zf)) {
      const s = er(Oa(e.modes)), a = Bs(s);
    ...
    const n2 = sr(e, "modes") ? er(Oa(e.modes)) : Oa(e), i = _e(n2, (s) => t5(s.categoryMatches));
    this.tokenMatcher = i ? bn : Fr, Ur(Oa(this.tokensMap));
  }
  defineRule(e, t, n2) {
...
Make sure that all grammar rule definitions are done before 'performSelfAnalysis' is called.`);
  ...
  orInternal(e, t) {
    const n2 = this.getKeyForAutomaticLookahead(Iu, t), i = I0(e) ? e : e.DEF, s = this.getLaFuncFromCache(n2).call(this, i);
    if (s !== void 0)
...
function Ht(r, e, t, n2 = false) {
  _n(t);
  const i = fr(this.recordingProdStack), s = Km(e) ? e : e.DEF, a = new r({ definition: [], idx: t });
...
function ep(r, e) {
  _n(e);
  const t = fr(this.recordingProdStack), n2 = I0(r) === false, i = n2 === false ? r : r.DEF, s = new ge({
    definition: [],
    idx: e,
    ignoreAmbiguities: n2 && r.IGNORE_AMBIGUITIES === true
  });
  sr(r, "MAX_LOOKAHEAD") && (s.maxLookahead = r.MAX_LOOKAHEAD);
  const a = Ll(i, (o) => Km(o.GATE));
  ...
  performSelfAnalysis() {
    this.TRACE_INIT("performSelfAnalysis", () => {
      ...
      if (this.TRACE_INIT("Grammar Resolving", () => {
        n2 = Ih({
          rules: Oa(this.gastProductionsCache)
        }), this.definitionErrors = this.definitionErrors.concat(n2);
      }), this.TRACE_INIT("Grammar Validations", () => {
        if (t5(n2) && this.skipValidations === false) {
          const i = Sh({
            rules: Oa(this.gastProductionsCache),
            tokenTypes: Oa(this.tokensMap),
            errMsgProvider: pt,
            grammarName: t
          }), s = dh({
      ...
      }), t5(this.definitionErrors) && (this.recoveryEnabled && this.TRACE_INIT("computeAllProdsFollows", () => {
        const i = cf(Oa(this.gastProductionsCache));
        this.resyncFollows = i;
      }), this.TRACE_INIT("ComputeLookaheadFunctions", () => {
        var i, s;
        (s = (i = this.lookaheadStrategy).initialize) === null || s === void 0 || s.call(i, {
          rules: Oa(this.gastProductionsCache)
        }), this.preComputeLookaheadFunctions(Oa(this.gastProductionsCache));
      })), !_Gr.DEFER_DEFINITION_ERRORS_HANDLING && !t5(this.definitionErrors))
...
function Mu(r, e, t, n2, i) {
  ...
  return s.loopback = o, l.loopback = o, r.decisionMap[Pt(e, i ? "RepetitionMandatoryWithSeparator" : "RepetitionMandatory", t.idx)] = o, W2(a, o), i === void 0 ? (W2(o, s), W2(o, l)) : (W2(o, l), W2(o, i.left), W2(i.right, s)), {
    left: s,
    right: l
  };
}
function Du2(r, e, t, n2, i) {
  const s = n2.left, a = n2.right, o = X(r, e, t, {
    type: op
  });
  st(r, o);
  ...
  return o.loopback = u, l.loopback = u, W2(o, s), W2(o, l), W2(a, u), i !== void 0 ? (W2(u, l), W2(u, i.left), W2(i.right, s)) : W2(u, o), r.decisionMap[Pt(e, i ? "RepetitionWithSeparator" : "Repetition", t.idx)] = o, {
    left: o,
    right: l
  };
}
function yp(r, e, t, n2) {
  ...
  return W2(i, s), r.decisionMap[Pt(e, "Option", t.idx)] = i, n2;
}
function st(r, e) {
...
function Vt(r, e, t, n2, ...i) {
  ...
  t.end = s;
  for (const o of i)
    o !== void 0 ? (W2(t, o.left), W2(o.right, s)) : W2(t, s);
  const a = {
    left: t,
    right: s
  };
...
function vp(r, e) {
  ...
  for (let s = 0; s < t - 1; s++) {
    ...
    a.left.type === rt && a.right.type === rt && o !== void 0 && (l && u.followState === a.right || o.target === a.right) ? (l ? u.followState = c : o.target = c, Ep(r, a.right)) : W2(a.right, c);
  }
...
var kp = class extends ta {
  ...
  buildLookaheadForOptional(e) {
    ...
    if (qa(c) && c[0][0] && !s) {
      const d = c[0], f = er(d);
      if (f.length === 1 && t5(f[0].categoryMatches)) {
...
(() => {
  var r = { 470: (i) => {
    ...
    var o = { resolve: function() {
      ...
      for (var m = u.length - h, g = f < m ? f : m, k = -1, R = 0; R <= g; ++R) {
        if (R === g) {
          if (m > g) {
            if (u.charCodeAt(h + R) === 47) return u.slice(h + R + 1);
            if (R === 0) return u.slice(h + R);
          } else f > g && (l.charCodeAt(c + R) === 47 ? k = R : R === 0 && (k = 0));
          break;
        }
        var $ = l.charCodeAt(c + R);
        if ($ !== u.charCodeAt(h + R)) break;
        $ === 47 && (k = R);
      }
      var T = "";
      for (R = c + k + 1; R <= d; ++R) R !== d && l.charCodeAt(R) !== 47 || (T.length === 0 ? T += ".." : T += "/..");
      ...
      f ? (u.root = "/", c = 1) : c = 0;
      for (var h = -1, m = 0, g = -1, k = true, R = l.length - 1, $ = 0; R >= c; --R) if ((d = l.charCodeAt(R)) !== 47) g === -1 && (k = false, g = R + 1), d === 46 ? h === -1 ? h = R : $ !== 1 && ($ = 1) : h !== -1 && ($ = -1);
      else if (!k) {
        m = R + 1;
        break;
      }
...
function qm(r) {
  ...
  for (let o = 0; o < r.lines.length; o++) {
    ...
    if (c = c.substring(0, Zm2(c)), Ms(c, d) >= c.length) {
      if (i.length > 0) {
...
function at(r) {
  return {
    ...
    parser: {
      ...
      LexerErrorMessageProvider: () => new Km2()
    },
    workspace: {
...
var xt = {
  AstReflection: v(() => new fc2(), "AstReflection")
};
var Kg = {
...
var xy = {
  info: v(async () => {
    const { createInfoServices: r } = await import("./info-63CPKGFF-CaiCNFzu-BcsCVoNU-KV5U7A3R.js"), e = r().Info.parser.LangiumParser;
    He.info = e;
  }, "info"),
  packet: v(async () => {
    const { createPacketServices: r } = await import("./packet-HUATNLJX-IrwjUFqo-BrN4YKcU-R3FN63RA.js"), e = r().Packet.parser.LangiumParser;
    He.packet = e;
  }, "packet"),
  pie: v(async () => {
    const { createPieServices: r } = await import("./pie-WTHONI2E-CPRfbGWC-lCu4Wxmr-7NL3RU4O.js"), e = r().Pie.parser.LangiumParser;
    He.pie = e;
  }, "pie"),
  architecture: v(async () => {
    const { createArchitectureServices: r } = await import("./architecture-O4VJ6CD3-KwEC5Tk4-CwsEzXJp-KKOCKEBG.js"), e = r().Architecture.parser.LangiumParser;
    He.architecture = e;
  }, "architecture"),
  gitGraph: v(async () => {
    const { createGitGraphServices: r } = await import("./gitGraph-ZV4HHKMB-CKagwBqI-C9uStFpm-ZQIKGPCS.js"), e = r().GitGraph.parser.LangiumParser;
    He.gitGraph = e;
  }, "gitGraph"),
  radar: v(async () => {
    const { createRadarServices: r } = await import("./radar-NJJJXTRR-DuKy2tDV-CtdypV3i-XEX3TU5X.js"), e = r().Radar.parser.LangiumParser;
    He.radar = e;
  }, "radar"),
  treemap: v(async () => {
    const { createTreemapServices: r } = await import("./treemap-75Q7IDZK-DXztvJ2e-BSUAwKiX-VXWXZ34S.js"), e = r().Treemap.parser.LangiumParser;
    He.treemap = e;
  }, "treemap")
};
...
//# sourceMappingURL=chunk-7MGNJ6NO.js.map
