...
// node_modules/.pnpm/vitepress-plugin-legend@1.0.2_jiti@1.21.7_markmap-common@0.18.9_typescript@5.4.3_yaml@2.7.0/node_modules/vitepress-plugin-legend/dist/mindmap-definition-6CBA2TL7-B8qFDYAN-CBG1vRNQ.js
var it = { exports: {} };
var rt = { exports: {} };
var nt = { exports: {} };
var Ot2 = nt.exports;
      ...
      return (
        ...
        function(p) {
            ...
            s.prototype.getEdges = function() {
              ...
              if (o.add(this), this.child != null)
                for (var E = this.child.getNodes(), m = 0; m < E.length; m++)
                  d = E[m], c = d.withChildren(), c.forEach(function(_2) {
                    o.add(_2);
                  });
              return o;
              ...
              var m = -r.INITIAL_WORLD_BOUNDARY, _2 = r.INITIAL_WORLD_BOUNDARY;
              d = r.WORLD_CENTER_Y + h.nextDouble() * (_2 - m) + m, this.rect.x = o, this.rect.y = d;
          ...
          function(p, T, f) {
            ...
            function d(E, m, _2) {
              i.call(this, _2), this.estimatedSize = t.MIN_VALUE, this.margin = e.DEFAULT_GRAPH_MARGIN, this.edges = [], this.nodes = [], this.isConnected = false, this.parent = E, m != null && m instanceof r ? this.graphManager = m : m != null && m instanceof Layout && (this.graphManager = m.graphManager);
            }
            ...
            d.prototype.getNodes = function() {
            ...
            }, d.prototype.add = function(E, m, _2) {
              if (m == null && _2 == null) {
                var N = E;
                ...
                var D = E;
                if (!(this.getNodes().indexOf(m) > -1 && this.getNodes().indexOf(_2) > -1))
                  throw "Source or target not in graph!";
                if (!(m.owner == _2.owner && m.owner == this))
                  throw "Both owners must be this graph!";
                return m.owner != _2.owner ? null : (D.source = m, D.target = _2, D.isInterGraph = false, this.getEdges().push(D), m.edges.push(D), _2 != m && _2.edges.push(D), D);
              }
              ...
              if (E instanceof h) {
                ...
                for (var _2 = m.edges.slice(), N, D = _2.length, g = 0; g < D; g++)
                  N = _2[g], N.isInterGraph ? this.graphManager.remove(N) : N.source.owner.remove(N);
              ...
              for (var E = t.MAX_VALUE, m = t.MAX_VALUE, _2, N, D, g = this.getNodes(), L = g.length, n = 0; n < L; n++) {
                var u = g[n];
                _2 = u.getTop(), N = u.getLeft(), E > _2 && (E = _2), m > N && (m = N);
              }
              ...
              for (var m = t.MAX_VALUE, _2 = -t.MAX_VALUE, N = t.MAX_VALUE, D = -t.MAX_VALUE, g, L, n, u, l, v = this.nodes, A = v.length, I = 0; I < A; I++) {
                var w = v[I];
                E && w.child != null && w.updateBounds(), g = w.getLeft(), L = w.getRight(), n = w.getTop(), u = w.getBottom(), m > g && (m = g), _2 < L && (_2 = L), N > n && (N = n), D < u && (D = u);
              }
              var R = new s(m, N, _2 - m, D - N);
              ...
              for (var m = t.MAX_VALUE, _2 = -t.MAX_VALUE, N = t.MAX_VALUE, D = -t.MAX_VALUE, g, L, n, u, l = E.length, v = 0; v < l; v++) {
                var A = E[v];
                g = A.getLeft(), L = A.getRight(), n = A.getTop(), u = A.getBottom(), m > g && (m = g), _2 < L && (_2 = L), N > n && (N = n), D < u && (D = u);
              }
              var I = new s(m, N, _2 - m, D - N);
              return I;
              ...
              for (var E = 0, m = this.nodes, _2 = m.length, N = 0; N < _2; N++) {
                var D = m[N];
              ...
              var m = new o(), _2 = /* @__PURE__ */ new Set(), N = this.nodes[0], D, g, L = N.withChildren();
              for (L.forEach(function(I) {
                ...
                for (var n = D.length, u = 0; u < n; u++) {
                  var l = D[u];
                  if (g = l.getOtherEndInGraph(N, this), g != null && !_2.has(g)) {
              ...
              if (this.isConnected = false, _2.size >= this.nodes.length) {
                var A = 0;
                _2.forEach(function(I) {
                  I.owner == E && A++;
          ...
          function(p, T, f) {
            ...
            t.calcSeparationAmount = function(e, r, h, a) {
              ...
              var d = e.getX(), c = e.getY(), E = e.getRight(), m = e.getX(), _2 = e.getBottom(), N = e.getRight(), D = e.getWidthHalf(), g = e.getHeightHalf(), L = r.getX(), n = r.getY(), u = r.getRight(), l = r.getX(), v = r.getBottom(), A = r.getRight(), I = r.getWidthHalf(), w = r.getHeightHalf(), R = false, S = false;
              if (a === y) {
                if (s > o)
                  return h[0] = a, h[1] = c, h[2] = y, h[3] = v, false;
                if (s < o)
                  return h[0] = a, h[1] = _2, h[2] = y, h[3] = n, false;
              } else if (s === o) {
                if (a > y)
                ...
                if (-U === C ? a > y ? (h[0] = m, h[1] = _2, R = true) : (h[0] = E, h[1] = c, R = true) : U === C && (a > y ? (h[0] = d, h[1] = c, R = true) : (h[0] = N, h[1] = _2, R = true)), -G === C ? y > a ? (h[2] = l, h[3] = v, S = true) : (h[2] = u, h[3] = n, S = true) : G === C && (y > a ? (h[2] = L, h[3] = n, S = true) : (h[2] = A, h[3] = v, S = true)), R && S)
                  return false;
              ...
              var s = e.x, y = e.y, o = r.x, d = r.y, c = h.x, E = h.y, m = a.x, _2 = a.y, N = void 0, D = void 0, g = void 0, L = void 0, n = void 0, u = void 0, l = void 0, v = void 0, A = void 0;
              return g = d - y, n = s - o, l = o * y - s * d, L = _2 - E, u = c - m, v = m * E - c * _2, A = g * u - L * n, A === 0 ? null : (N = (n * v - u * l) / A, D = (L * l - g * v) / A, new i(N, D));
              ...
              var s = e.x, y = e.y, o = r.x, d = r.y, c = h.x, E = h.y, m = a.x, _2 = a.y, N = (o - s) * (_2 - E) - (m - c) * (d - y);
              if (N === 0)
                return false;
              var D = ((_2 - E) * (m - s) + (c - m) * (_2 - y)) / N, g = ((y - d) * (m - s) + (o - s) * (_2 - y)) / N;
          ...
          function(p, T, f) {
            ...
            d.RANDOM_SEED = 1, d.prototype = Object.create(o.prototype), d.prototype.getGraphManager = function() {
              ...
              if (c == null)
                ...
                var E = c;
                if (E.getChild() != null)
                  for (var m = E.getChild().getNodes(), _2 = 0; _2 < m.length; _2++)
                    update(m[_2]);
              ...
              if (c == null)
                ...
                if (m != null) {
                  ...
                  for (var _2 = this.getAllNodes(), N, D = 0; D < _2.length; D++)
                    N = _2[D], N.transform(E);
                }
              }
              ...
              if (c == null)
                ...
                for (var E, m, _2 = c.getNodes(), N = 0; N < _2.length; N++)
                  E = _2[N], m = E.getChild(), m == null || m.getNodes().length == 0 ? E.scatter() : (this.positionNodesRandomly(m), E.updateBounds());
            }, d.prototype.getFlatForest = function() {
              for (var c = [], E = true, m = this.graphManager.getRoot().getNodes(), _2 = true, N = 0; N < m.length; N++)
                m[N].getChild() != null && (_2 = false);
              if (!_2)
                return c;
              ...
              for (var E = [], m = c.source, _2 = this.graphManager.calcLowestCommonAncestor(c.source, c.target), N = 0; N < c.bendpoints.length; N++) {
                var D = this.newNode(null);
                D.setRect(new Point(0, 0), new Dimension(1, 1)), _2.add(D);
                var g = this.newEdge(null);
                this.graphManager.add(g, m, D), E.add(D), m = D;
              }
              var g = this.newEdge(null);
              return this.graphManager.add(g, m, c.target), this.edgeToDummyNodes.set(c, E), c.isInterGraph() ? this.graphManager.remove(c) : _2.remove(c), E;
              ...
              for (var E = 0; E < c.length; E++) {
                ...
                if (m.bendpoints.length > 0) {
                  for (var _2 = this.edgeToDummyNodes.get(m), N = 0; N < _2.length; N++) {
                    var D = _2[N], g = new s(D.getCenterX(), D.getCenterY()), L = m.bendpoints.get(N);
                    L.x = g.x, L.y = g.y, D.getOwner().remove(D);
                  }
                  this.graphManager.add(m, m.source, m.target);
                }
              }
            }, d.transform = function(c, E, m, _2) {
              if (m != null && _2 != null) {
                var N = E;
                if (c <= 50) {
                  var D = E / m;
              ...
              var E = [];
              E = E.concat(c);
              var m = [], _2 = /* @__PURE__ */ new Map(), N = false, D = null;
              (E.length == 1 || E.length == 2) && (N = true, D = E[0]);
              for (var g = 0; g < E.length; g++) {
                var L = E[g], n = L.getNeighborsList().size;
                _2.set(L, L.getNeighborsList().size), n == 1 && m.push(L);
              }
              var u = [];
              for (u = u.concat(m); !N; ) {
                var l = [];
                ...
                for (var g = 0; g < E.length; g++) {
                  ...
                  A.forEach(function(R) {
                    if (m.indexOf(R) < 0) {
                      var S = _2.get(R), U = S - 1;
                      U == 1 && u.push(R), _2.set(R, U);
                    }
                  });
                }
          ...
          function(p, T, f) {
            ...
            s.prototype.initParameters = function() {
              ...
              var o = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true, d = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false, c, E, m, _2, N = this.getAllNodes(), D;
              if (this.useFRGridVariant)
                ...
                for (c = 0; c < N.length; c++)
                  for (m = N[c], E = c + 1; E < N.length; E++)
                    _2 = N[E], m.getOwner() == _2.getOwner() && this.calcRepulsionForce(m, _2);
              ...
              var c = o.getSource(), E = o.getTarget(), m, _2, N, D;
              if (this.uniformLeafNodeSizes && c.getChild() == null && E.getChild() == null)
                ...
                return;
              m = o.getLength(), m != 0 && (_2 = this.springConstant * (m - d), N = _2 * (o.lengthX / m), D = _2 * (o.lengthY / m), c.springForceX += N, c.springForceY += D, E.springForceX -= N, E.springForceY -= D);
            }, s.prototype.calcRepulsionForce = function(o, d) {
              var c = o.getRect(), E = d.getRect(), m = new Array(2), _2 = new Array(4), N, D, g, L, n, u, l;
              if (c.intersects(E)) {
                ...
                this.uniformLeafNodeSizes && o.getChild() == null && d.getChild() == null ? (N = E.getCenterX() - c.getCenterX(), D = E.getCenterY() - c.getCenterY()) : (h.getIntersection(c, E, _2), N = _2[2] - _2[0], D = _2[3] - _2[1]), Math.abs(N) < e.MIN_REPULSION_DIST && (N = a.sign(N) * e.MIN_REPULSION_DIST), Math.abs(D) < e.MIN_REPULSION_DIST && (D = a.sign(D) * e.MIN_REPULSION_DIST), g = N * N + D * D, L = Math.sqrt(g), n = this.repulsionConstant * o.noOfChildren * d.noOfChildren / g, u = n * N / L, l = n * D / L, o.repulsionForceX -= u, o.repulsionForceY -= l, d.repulsionForceX += u, d.repulsionForceY += l;
            }, s.prototype.calcGravitationalForce = function(o) {
              var d, c, E, m, _2, N, D, g;
              d = o.getOwner(), c = (d.getRight() + d.getLeft()) / 2, E = (d.getTop() + d.getBottom()) / 2, m = o.getCenterX() - c, _2 = o.getCenterY() - E, N = Math.abs(m) + o.getWidth() / 2, D = Math.abs(_2) + o.getHeight() / 2, o.getOwner() == this.graphManager.getRoot() ? (g = d.getEstimatedSize() * this.gravityRangeFactor, (N > g || D > g) && (o.gravitationForceX = -this.gravityConstant * m, o.gravitationForceY = -this.gravityConstant * _2)) : (g = d.getEstimatedSize() * this.compoundGravityRangeFactor, (N > g || D > g) && (o.gravitationForceX = -this.gravityConstant * m * this.compoundGravityConstant, o.gravitationForceY = -this.gravityConstant * _2 * this.compoundGravityConstant));
              ...
              var E = 0, m = 0, _2 = 0, N = 0;
              E = parseInt(Math.floor((o.getRect().x - d) / this.repulsionRange)), m = parseInt(Math.floor((o.getRect().width + o.getRect().x - d) / this.repulsionRange)), _2 = parseInt(Math.floor((o.getRect().y - c) / this.repulsionRange)), N = parseInt(Math.floor((o.getRect().height + o.getRect().y - c) / this.repulsionRange));
              for (var D = E; D <= m; D++)
                for (var g = _2; g <= N; g++)
                  this.grid[D][g].push(o), o.setGridCoordinates(E, m, _2, N);
              ...
              if (this.totalIterations % e.GRID_CALCULATION_CHECK_PERIOD == 1 && c || E) {
                ...
                for (var _2, N = this.grid, D = o.startX - 1; D < o.finishX + 2; D++)
                  for (var g = o.startY - 1; g < o.finishY + 2; g++)
                    if (!(D < 0 || g < 0 || D >= N.length || g >= N[0].length)) {
                      for (var L = 0; L < N[D][g].length; L++)
                        if (_2 = N[D][g][L], !(o.getOwner() != _2.getOwner() || o == _2) && !d.has(_2) && !m.has(_2)) {
                          var n = Math.abs(o.getCenterX() - _2.getCenterX()) - (o.getWidth() / 2 + _2.getWidth() / 2), u = Math.abs(o.getCenterY() - _2.getCenterY()) - (o.getHeight() / 2 + _2.getHeight() / 2);
                          n <= this.repulsionRange && u <= this.repulsionRange && m.add(_2);
                        }
                    }
    ...
    (function(p, T) {
      ...
      return (
        ...
        function(T) {
          ...
          /***/
          function(T, f, i) {
            var t = i(0).FDLayout, e = i(4), r = i(3), h = i(5), a = i(2), s = i(1), y = i(0).FDLayoutConstants, o = i(0).LayoutConstants, d = i(0).Point, c = i(0).PointD, E = i(0).Layout, m = i(0).Integer, _2 = i(0).IGeometry, N = i(0).LGraph, D = i(0).Transform;
            function g() {
            ...
            g.prototype.newGraphManager = function() {
              ...
              var w = (v - l + 1) / 2;
              w < 0 && (w += 180);
              var R = (w + l) % 360, S = R * _2.TWO_PI / 360, U = A * Math.cos(S), G = A * Math.sin(S);
              n.setCenter(U, G);
              var C = [];
      ...
      return (
        ...
        function(T) {
          ...
          function(T, f, i) {
            ...
            function c(_2) {
              this.options = d(o, _2), E(this.options);
            }
            var E = function(_2) {
              _2.nodeRepulsion != null && (r.DEFAULT_REPULSION_STRENGTH = e.DEFAULT_REPULSION_STRENGTH = _2.nodeRepulsion), _2.idealEdgeLength != null && (r.DEFAULT_EDGE_LENGTH = e.DEFAULT_EDGE_LENGTH = _2.idealEdgeLength), _2.edgeElasticity != null && (r.DEFAULT_SPRING_STRENGTH = e.DEFAULT_SPRING_STRENGTH = _2.edgeElasticity), _2.nestingFactor != null && (r.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR = e.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR = _2.nestingFactor), _2.gravity != null && (r.DEFAULT_GRAVITY_STRENGTH = e.DEFAULT_GRAVITY_STRENGTH = _2.gravity), _2.numIter != null && (r.MAX_ITERATIONS = e.MAX_ITERATIONS = _2.numIter), _2.gravityRange != null && (r.DEFAULT_GRAVITY_RANGE_FACTOR = e.DEFAULT_GRAVITY_RANGE_FACTOR = _2.gravityRange), _2.gravityCompound != null && (r.DEFAULT_COMPOUND_GRAVITY_STRENGTH = e.DEFAULT_COMPOUND_GRAVITY_STRENGTH = _2.gravityCompound), _2.gravityRangeCompound != null && (r.DEFAULT_COMPOUND_GRAVITY_RANGE_FACTOR = e.DEFAULT_COMPOUND_GRAVITY_RANGE_FACTOR = _2.gravityRangeCompound), _2.initialEnergyOnIncremental != null && (r.DEFAULT_COOLING_FACTOR_INCREMENTAL = e.DEFAULT_COOLING_FACTOR_INCREMENTAL = _2.initialEnergyOnIncremental), _2.quality == "draft" ? t.QUALITY = 0 : _2.quality == "proof" ? t.QUALITY = 2 : t.QUALITY = 1, r.NODE_DIMENSIONS_INCLUDE_LABELS = e.NODE_DIMENSIONS_INCLUDE_LABELS = t.NODE_DIMENSIONS_INCLUDE_LABELS = _2.nodeDimensionsIncludeLabels, r.DEFAULT_INCREMENTAL = e.DEFAULT_INCREMENTAL = t.DEFAULT_INCREMENTAL = !_2.randomize, r.ANIMATE = e.ANIMATE = t.ANIMATE = _2.animate, r.TILE = _2.tile, r.TILING_PADDING_VERTICAL = typeof _2.tilingPaddingVertical == "function" ? _2.tilingPaddingVertical.call() : _2.tilingPaddingVertical, r.TILING_PADDING_HORIZONTAL = typeof _2.tilingPaddingHorizontal == "function" ? _2.tilingPaddingHorizontal.call() : _2.tilingPaddingHorizontal;
            };
            c.prototype.run = function() {
              var _2, N, D = this.options;
              this.idToLNode = {};
              ...
              var S = function(G, C) {
                ...
                for (var C = function() {
                  D.fit && D.cy.fit(D.eles, D.padding), _2 || (_2 = true, L.cy.one("layoutready", D.ready), L.cy.trigger({ type: "layoutready", layout: L }));
                }, x = L.options.refresh, F, k = 0; k < x && !F; k++)
                  F = L.stopped || L.layout.tick();
                if (F) {
                  g.checkLayoutSuccess() && !g.isSubLayout && g.doPostLayout(), g.tilingPostLayout && g.tilingPostLayout(), g.isLayoutFinished = true, L.options.eles.nodes().positions(S), C(), L.cy.one("layoutstop", L.options.stop), L.cy.trigger({ type: "layoutstop", layout: L }), N && cancelAnimationFrame(N), _2 = false;
                  return;
                }
              ...
              }), g.runLayout(), this.options.animate !== "during" && (L.options.eles.nodes().not(":parent").layoutPositions(L, L.options, S), _2 = false), this;
            }, c.prototype.getTopMostNodes = function(_2) {
              for (var N = {}, D = 0; D < _2.length; D++)
                N[_2[D].id()] = true;
              var g = _2.filter(function(L, n) {
                typeof L == "number" && (L = n);
              ...
              return g;
            }, c.prototype.processChildrenList = function(_2, N, D) {
              for (var g = N.length, L = 0; L < g; L++) {
                var n = N[L], u = n.children(), l, v = n.layoutDimensions({
                  nodeDimensionsIncludeLabels: this.options.nodeDimensionsIncludeLabels
                });
                if (n.outerWidth() != null && n.outerHeight() != null ? l = _2.add(new a(D.graphManager, new s(n.position("x") - v.w / 2, n.position("y") - v.h / 2), new y(parseFloat(v.w), parseFloat(v.h)))) : l = _2.add(new a(this.graphManager)), l.id = n.data("id"), l.paddingLeft = parseInt(n.css("padding")), l.paddingTop = parseInt(n.css("padding")), l.paddingRight = parseInt(n.css("padding")), l.paddingBottom = parseInt(n.css("padding")), this.options.nodeDimensionsIncludeLabels && n.isParent()) {
...
var ot = function() {
  var O = _(function(D, g, L, n) {
    ...
    performAction: _(function(D, g, L, n, u, l, v) {
      var A = l.length - 1;
      switch (u) {
        case 6:
        case 7:
...
` + this.showPosition(), {
      ...
      performAction: _(function(g, L, n, u) {
        switch (n) {
          case 0:
  ...
  return _(N, "Parser"), N.prototype = m, m.Parser = N, new N();
}();
ot.parser = ot;
var Gt = ot;
var bt = {
...
var Ft = (tt = class {
  ...
  addNode(O, M, p, T) {
    ...
    const f = fe();
    let i = ((_a = f.mindmap) == null ? void 0 : _a.padding) ?? N6.mindmap.padding;
    switch (T) {
  ...
  decorateNode(O) {
    if (!O)
      return;
    const M = fe(), p = this.nodes[this.nodes.length - 1];
    O.icon && (p.icon = Zs(O.icon, M)), O.class && (p.class = Zs(O.class, M));
  }
  type2Str(O) {
    switch (O) {
...
_(dt, "insertPolygonShape");
var $t = _(function(O, M, p) {
...
var Wt = _(async function(O, M, p, T, f) {
...
`);
  ...
  const y = a.node().getBBox(), [o] = Nu(f.fontSize);
...
` + O);
  ...
  pt(r, a), yt(f, a), FR(
    void 0,
    e,
    ((_a = t.mindmap) == null ? void 0 : _a.padding) ?? N6.mindmap.padding,
    ((_b = t.mindmap) == null ? void 0 : _b.useMaxWidth) ?? N6.mindmap.useMaxWidth
  );
}, "draw");
var zt = {
  draw: Vt
...
var qt = _((O) => {
  ...
  for (let p = 0; p < O.THEME_COLOR_LIMIT; p++)
    O["lineColor" + p] = O["lineColor" + p] || O["cScaleInv" + p], lc(O["lineColor" + p]) ? O["lineColor" + p] = Tt(O["lineColor" + p], 20) : O["lineColor" + p] = Ot(O["lineColor" + p], 20);
  for (let p = 0; p < O.THEME_COLOR_LIMIT; p++) {
    const T = "" + (17 - 3 * p);
    M += `
...
//# sourceMappingURL=mindmap-definition-6CBA2TL7-B8qFDYAN-CBG1vRNQ-TGN5Z7UY.js.map
