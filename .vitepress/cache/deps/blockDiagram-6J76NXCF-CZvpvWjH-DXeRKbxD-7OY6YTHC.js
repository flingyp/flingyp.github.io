...
// node_modules/.pnpm/vitepress-plugin-legend@1.0.4_jiti@1.21.7_markmap-common@0.18.9_typescript@5.4.3_yaml@2.8.0/node_modules/vitepress-plugin-legend/dist/blockDiagram-6J76NXCF-CZvpvWjH-DXeRKbxD.js
var xt = function() {
  var e2 = S(function(v, c, p, w) {
    for (p = p || {}, w = v.length; w--; p[v[w]] = c) ;
    return p;
  }, "o"), t = [1, 7], a = [1, 13], n2 = [1, 14], i = [1, 15], r = [1, 19], s = [1, 16], l2 = [1, 17], o = [1, 18], u = [8, 30], h = [8, 21, 28, 29, 30, 31, 32, 40, 44, 47], x = [1, 23], f = [1, 24], b = [8, 15, 16, 21, 28, 29, 30, 31, 32, 40, 44, 47], L = [8, 15, 16, 21, 27, 28, 29, 30, 31, 32, 40, 44, 47], k = [1, 49], S2 = {
    trace: S(function() {
    }, "trace"),
    yy: {},
    ...
    performAction: S(function(v, c, p, w, E, d, _) {
      var y2 = d.length - 1;
      switch (E) {
        case 4:
    ...
    parse: S(function(v) {
      ...
      S(Dt, "lex");
      for (var P, Q, X, ut2, J = {}, at, Z, vt, st; ; ) {
        if (Q = p[p.length - 1], this.defaultActions[Q] ? X = this.defaultActions[Q] : ((P === null || typeof P > "u") && (P = Dt()), X = _[Q] && _[Q][P]), typeof X > "u" || !X.length || !X[0]) {
          var yt = "";
          st = [];
          for (at in _[Q])
...
Expecting ` + st.join(", ") + ", got '" + (this.terminals_[P] || P) + "'" : yt = "Parse error on line " + (A + 1) + ": Unexpected " + (P == j ? "end of input" : "'" + (this.terminals_[P] || P) + "'"), this.parseError(yt, {
        ...
        switch (X[0]) {
          ...
          case 2:
            ...
            ]), ut2 = this.performAction.apply(J, [
              y2,
              O,
              A,
              V.yy,
...
` + this.showPosition(), {
      ...
      options: {},
      performAction: S(function(c, p, w, E) {
        switch (w) {
          case 0:
            return 10;
          case 1:
  ...
  return S(D, "Parser"), D.prototype = S2, S2.Parser = D, new D();
}();
xt.parser = xt;
var Se = xt;
...
var De = S((e2) => ga.sanitizeText(e2, Ee), "sanitizeText");
var ve = S(function(e2, t = "") {
  let a = lt.get(e2);
...
var Ne = S(function(e2, t = "") {
  const a = U.get(e2);
  t != null && (a.styles = t.split(Pt));
}, "addStyle2Node");
var $e = S(function(e2, t) {
...
var Te = S(() => {
  ut.debug("Clear called"), hP(), et = { id: "root", type: "composite", children: [], columns: -1 }, U = /* @__PURE__ */ new Map([["root", et]]), kt = [], lt = /* @__PURE__ */ new Map(), Lt = [], bt = /* @__PURE__ */ new Map();
}, "clear");
function Wt(e2) {
...
S(Kt, "edgeStrToEdgeData");
var Ct = 0;
var Ce = S(() => (Ct++, "id-" + Math.random().toString(36).substr(2, 12) + "-" + Ct), "generateId");
var Ie = S((e2) => {
  et.children = e2, Yt(e2, et), kt = et.children;
}, "setHierarchy");
var Be = S((e2) => {
  const t = U.get(e2);
  return t ? t.columns ? t.columns : t.children ? t.children.length : -1 : -1;
}, "getColumns");
var Oe = S(() => [...U.values()], "getBlocksFlat");
var ze = S(() => kt || [], "getBlocks");
var Re = S(() => Lt, "getEdges");
var Ae = S((e2) => U.get(e2), "getBlock");
var Me = S((e2) => {
  U.set(e2.id, e2);
}, "setBlock");
var Pe = S(() => ut, "getLogger");
var Ye = S(function() {
  return lt;
}, "getClasses");
var We = {
  getConfig: S(() => Vr().block, "getConfig"),
  typeStr2Type: Wt,
  edgeTypeStr2Type: Xt,
...
var rr = Fe;
var _a, _b;
var C = ((_b = (_a = me()) == null ? void 0 : _a.block) == null ? void 0 : _b.padding) ?? 8;
function Ut(e2, t) {
...
function ot(e2, t, a = 0, n2 = 0) {
  ...
  if (((_c = e2.children) == null ? void 0 : _c.length) > 0) {
    ...
    if (x < a) {
      ...
      for (const k of e2.children)
        k.size && (k.size.width = b, k.size.height = L, k.size.x = 0, k.size.y = 0);
    }
    if (ut.debug(
...
function St(e2, t) {
  ...
  e2.children.length > 0) {
    ...
    for (const o of e2.children) {
      ...
      o.children && St(o), r += (o == null ? void 0 : o.widthInColumns) ?? 1, ut.debug("abc88 columnsPos", o, r);
    }
  }
  ut.debug(
...
function Ft(e2) {
  ...
  if (!t)
    return;
  ot(t, e2, 0, 0), St(t), ut.debug("getBlocks", JSON.stringify(t, null, 2));
...
var M = {};
var lr = S(async (e2, t) => {
  const a = me(), n2 = Qe(a.flowchart.htmlLabels), i = t.labelType === "markdown" ? ys(
    e2,
    t.label,
    {
      style: t.labelStyle,
...
function tt(e2, t) {
  me().flowchart.htmlLabels && e2 && (e2.style.width = t.length * 9 + "px", e2.style.height = "12px");
}
S(tt, "setTerminalWidth");
var or = S((e2, t) => {
  ut.debug("Moving label abc88 ", e2.id, e2.label, wt[e2.id], t);
  let a = t.updatedPath ? t.updatedPath : t.originalPath;
  const n2 = me(), { subGraphTitleTotalMargin: i } = Um(n2);
  if (e2.label) {
    const r = wt[e2.id];
    let s = e2.x, l2 = e2.y;
    if (a) {
      const o = Xn.calcLabelPosition(a);
      ut.debug(
  ...
  if (e2.startLabelLeft) {
    ...
    let s = e2.x, l2 = e2.y;
    if (a) {
      const o = Xn.calcTerminalLabelPosition(e2.arrowTypeStart ? 10 : 0, "start_left", a);
      s = o.x, l2 = o.y;
    }
  ...
  if (e2.startLabelRight) {
    ...
    let s = e2.x, l2 = e2.y;
    if (a) {
      const o = Xn.calcTerminalLabelPosition(
  ...
  if (e2.endLabelLeft) {
    ...
    let s = e2.x, l2 = e2.y;
    if (a) {
      const o = Xn.calcTerminalLabelPosition(e2.arrowTypeEnd ? 10 : 0, "end_left", a);
      s = o.x, l2 = o.y;
    }
    r.attr("transform", `translate(${s}, ${l2})`);
  }
  if (e2.endLabelRight) {
    ...
    let s = e2.x, l2 = e2.y;
    if (a) {
      const o = Xn.calcTerminalLabelPosition(e2.arrowTypeEnd ? 10 : 0, "end_right", a);
      s = o.x, l2 = o.y;
    }
    r.attr("transform", `translate(${s}, ${l2})`);
  }
...
var hr = S(function(e2, t, a, n2, i, r, s) {
  let l2 = a.points;
  ...
  const { x: b, y: L } = $j(a), k = eV().x(b).y(L).curve(f);
  let S2;
  switch (a.thickness) {
    case "normal":
  ...
  const T = e2.append("path").attr("d", k(x)).attr("id", a.id).attr("class", " " + S2 + (a.classes ? " " + a.classes : "")).attr("style", a.style);
  let D = "";
  (me().flowchart.arrowMarkerAbsolute || me().state.arrowMarkerAbsolute) && (D = cw(true)), ir(T, a, D, s, i);
  let v = {};
...
S(Zt, "intersectEllipse");
var qt = Zt;
function Vt(e2, t, a) {
  return qt(e2, t, t, a);
}
S(Vt, "intersectCircle");
var pr = Vt;
function Qt(e2, t, a, n2) {
  var i, r, s, l2, o, u, h, x, f, b, L, k, S2, T, D;
  if (i = t.y - e2.y, s = e2.x - t.x, o = t.x * e2.y - e2.x * t.y, f = i * a.x + s * a.y + o, b = i * n2.x + s * n2.y + o, !(f !== 0 && b !== 0 && mt(f, b)) && (r = n2.y - a.y, l2 = a.x - n2.x, u = n2.x * a.y - a.x * n2.y, h = r * e2.x + l2 * e2.y + u, x = r * t.x + l2 * t.y + u, !(h !== 0 && x !== 0 && mt(h, x)) && (L = i * l2 - r * s, L !== 0)))
    return k = Math.abs(L / 2), S2 = s * u - l2 * o, T = S2 < 0 ? (S2 - k) / L : (S2 + k) / L, S2 = r * o - i * u, D = S2 < 0 ? (S2 - k) / L : (S2 + k) / L, { x: T, y: D };
}
S(Qt, "intersectLine");
function mt(e2, t) {
  return e2 * t > 0;
...
function Jt(e2, t, a) {
  ...
  return r.length ? (r.length > 1 && r.sort(function(L, k) {
    var S2 = L.x - a.x, T = L.y - a.y, D = Math.sqrt(S2 * S2 + T * T), v = k.x - a.x, c = k.y - a.y, p = Math.sqrt(v * v + c * c);
    return D < p ? -1 : D === p ? 0 : 1;
  }), r[0]) : e2;
}
S(Jt, "intersectPolygon");
var fr = S((e2, t) => {
...
var R = S(async (e2, t, a, n2) => {
  const i = me();
  let r;
  const s = t.useHtmlLabels || Qe(i.flowchart.htmlLabels);
  ...
  let f = x.getBBox();
  const b = t.padding / 2;
  if (Qe(i.flowchart.htmlLabels)) {
    const L = x.children[0], k = ae(x), S2 = L.getElementsByTagName("img");
    if (S2) {
    ...
    f = L.getBoundingClientRect(), k.attr("width", f.width), k.attr("height", f.height);
  }
...
S(F, "insertPolygonShape");
var mr = S(async (e2, t) => {
  t.useHtmlLabels || me().flowchart.htmlLabels || (t.centerLabel = true);
...
var Lr = mr;
var Ot = S((e2) => e2 ? " " + e2 : "", "formatClass");
var W = S((e2, t) => `${t || "node default"}${Ot(e2.classes)} ${Ot(
  e2.class
)}`, "getClassesFromNode");
var zt = S(async (e2, t) => {
...
var zr = S(async (e2, t) => {
  ...
  if (Qe(me().flowchart.htmlLabels)) {
    const k = u.children[0], S2 = ae(u);
    h = k.getBoundingClientRect(), S2.attr("width", h.width), S2.attr("height", h.height);
  }
  ut.info("Text 2", l2);
  ...
  ), i.attr("class", "outer title-state").attr("x", -h.width / 2 - L).attr("y", -h.height / 2 - L).attr("width", h.width + t.padding).attr("height", h.height + t.padding), r.attr("class", "divider").attr("x1", -h.width / 2 - L).attr("x2", h.width / 2 + L).attr("y1", -h.height / 2 - L + f.height + L).attr("y2", -h.height / 2 - L + f.height + L), $(t, i), t.intersect = function(k) {
    return N.rect(t, k);
  }, n2;
}, "rectWithTitle");
var Rr = S(async (e2, t) => {
...
var Xr = S(async (e2, t) => {
  ...
  let b = 0;
  const L = (_a2 = t.classData.annotations) == null ? void 0 : _a2[0], k = t.classData.annotations[0] ? "«" + t.classData.annotations[0] + "»" : "", S2 = f.node().appendChild(await K(k, t.labelStyle, true, true));
  let T = S2.getBBox();
  if (Qe(me().flowchart.htmlLabels)) {
    const d = S2.children[0], _ = ae(S2);
  ...
  t.classData.type !== void 0 && t.classData.type !== "" && (me().flowchart.htmlLabels ? D += "&lt;" + t.classData.type + "&gt;" : D += "<" + t.classData.type + ">");
  const v = f.node().appendChild(await K(D, t.labelStyle, true, true));
  ae(v).attr("class", "classTitle");
  let c = v.getBBox();
  if (Qe(me().flowchart.htmlLabels)) {
    const d = v.children[0], _ = ae(v);
  ...
  t.classData.members.forEach(async (d) => {
    ...
    me().flowchart.htmlLabels && (y2 = y2.replace(/</g, "&lt;").replace(/>/g, "&gt;"));
  ...
  return ae(v).attr(
    ...
    const _ = d == null ? void 0 : d.getBBox();
    b += ((_ == null ? void 0 : _.height) ?? 0) + n2;
...
var nt = {};
var Gt = S(async (e2, t, a) => {
  let n2, i;
  if (t.link) {
    let r;
    me().securityLevel === "sandbox" ? r = "_top" : t.linkTarget && (r = t.linkTarget || "_blank"), n2 = e2.insert("svg:a").attr("xlink:href", t.link).attr("target", r), i = await At[t.shape](n2, t, a);
  } else
...
function Et(e2, t, a = false) {
  ...
  const o = cv((n2 == null ? void 0 : n2.styles) ?? []), u = n2.label, h = n2.size ?? { width: 0, height: 0, x: 0, y: 0 };
  return {
    ...
    intersect: void 0,
    type: n2.type,
    padding: l2 ?? ((_c = (_b2 = Vr()) == null ? void 0 : _b2.block) == null ? void 0 : _c.padding) ?? 0
  };
}
S(Et, "getNodeFromBlock");
async function te(e2, t, a) {
  const n2 = Et(t, a, false);
  if (n2.type === "group")
    return;
  const i = Vr(), r = await Gt(e2, n2, { config: i }), s = r.node().getBBox(), l2 = a.getBlock(n2.id);
  l2.size = { width: s.width, height: s.height, x: 0, y: 0, node: r }, a.setBlock(l2), r.remove();
}
S(te, "calculateBlockSize");
async function ee(e2, t, a) {
  const n2 = Et(t, a, true);
  if (a.getBlock(n2.id).type !== "space") {
    const i = Vr();
    await Gt(e2, n2, { config: i }), t.intersect = n2 == null ? void 0 : n2.intersect, Kr(n2);
  }
}
S(ee, "insertBlockPositioned");
async function dt(e2, t, a, n2) {
  for (const i of t)
    await n2(e2, i, a), i.children && await dt(e2, i.children, a, n2);
}
S(dt, "performOperations");
async function re(e2, t, a) {
  await dt(e2, t, a, te);
}
S(re, "calculateBlockSizes");
...
S(se, "insertEdges");
var Ur = S(function(e2, t) {
  return t.db.getClasses();
}, "getClasses");
var Fr = S(async function(e2, t, a, n2) {
  const { securityLevel: i, block: r } = Vr(), s = n2.db;
  let l2;
  i === "sandbox" && (l2 = ae("#i" + t));
  ...
  if (await ae2(b, h, s), await se(b, f, x, s, t), L) {
    const k = L, S2 = Math.max(1, Math.round(0.125 * (k.width / k.height))), T = k.height + S2 + 10, D = k.width + 10, { useMaxWidth: v } = r;
    hw(u, T, D, !!v), ut.debug("Here Bounds", L, k), u.attr(
      "viewBox",
...
//# sourceMappingURL=blockDiagram-6J76NXCF-CZvpvWjH-DXeRKbxD-7OY6YTHC.js.map
