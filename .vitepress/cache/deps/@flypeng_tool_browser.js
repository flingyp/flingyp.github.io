...
// node_modules/.pnpm/@flypeng+tool@5.7.0/node_modules/@flypeng/tool/dist/browser/index.js
...
var Oe = (e) => typeof e == "undefined";
var Ye = (e) => typeof e == "string";
var _e = (e) => typeof e == "number";
var Ge = (e) => e !== null && typeof e == "object";
var Be = (e) => Array.isArray(e);
var p = (e) => e.slice(8, -1).toLocaleLowerCase();
var We = (e) => p(x.call(e)) === "null";
var Ke = (e) => p(x.call(e)) === "function";
var Qe = (e) => p(x.call(e)) === "date";
var ze = (e) => p(x.call(e)) === "map";
var He = (e) => p(x.call(e)) === "set";
var Ve = (e) => p(x.call(e)) === "regexp";
var Ze = () => (navigator == null ? void 0 : navigator.userAgent.toLowerCase()).includes("micromessenger");
var je = () => ![typeof window, typeof document].includes("undefined");
...
var qe = (e) => x.call(e);
var a = { isUndefined: Oe, isString: Ye, isNumber: _e, isObject: Ge, isArray: Be, isNull: We, isFunction: Ke, isDate: Qe, isMap: ze, isSet: He, isRegExp: Ve, isBrowser: je, isWechatBrowser: Ze, isMobile: Je, typeToString: qe };
function P(e, t) {
  let n = null;
  return function(...r) {
...
var { isNull: Xe, isUndefined: e0, isDate: t0, isRegExp: n0, isObject: r0 } = a;
function v(e, t = /* @__PURE__ */ new WeakMap()) {
  if (Xe(e) || e0(e)) return e;
  if (t0(e)) return new Date(e);
  if (n0(e)) return new RegExp(e);
  if (!r0(e)) return e;
...
function o0(e, t = /* @__PURE__ */ new Date()) {
...
function i0(e, t = /* @__PURE__ */ new Date()) {
  return e.getFullYear() === t.getFullYear() && e.getMonth() + 1 === t.getMonth() + 1;
}
var d0 = { useLeapYear: be, useTodayWeek: f0, useMonthNumber: c0, useAddDateDay: b0, useDifDaysValue: o0, useGetFirstDay: a0, useGetLastDay: u0, useIsValidDate: s0, useIsSameMonth: i0 };
...
function ae(e, t) {
  ...
  let n = x0[e - 1900], r = [parseInt(`0x${n.substr(0, 5)}`).toString(), parseInt(`0x${n.substr(5, 5)}`).toString(), parseInt(`0x${n.substr(10, 5)}`).toString(), parseInt(`0x${n.substr(15, 5)}`).toString(), parseInt(`0x${n.substr(20, 5)}`).toString(), parseInt(`0x${n.substr(25, 5)}`).toString()], f = [r[0].substr(0, 1), r[0].substr(1, 2), r[0].substr(3, 1), r[0].substr(4, 2), r[1].substr(0, 1), r[1].substr(1, 2), r[1].substr(3, 1), r[1].substr(4, 2), r[2].substr(0, 1), r[2].substr(1, 2), r[2].substr(3, 1), r[2].substr(4, 2), r[3].substr(0, 1), r[3].substr(1, 2), r[3].substr(3, 1), r[3].substr(4, 2), r[4].substr(0, 1), r[4].substr(1, 2), r[4].substr(3, 1), r[4].substr(4, 2), r[5].substr(0, 1), r[5].substr(1, 2), r[5].substr(3, 1), r[5].substr(4, 2)];
...
function w0(e) {
  ...
  switch (e) {
    ...
    case 30:
      ...
      break;
    default:
      t = m0[Math.floor(e / 10)], t += de[e % 10];
  }
  return t;
}
function C0(e) {
...
function ue(e, t, n) {
  ...
  for (f = 1900; f < 2101 && o > 0; f++) b = le(f), o -= b;
  o < 0 && (o += b, f--);
  let i = /* @__PURE__ */ new Date(), h = false;
  i.getFullYear() === e && i.getMonth() + 1 === t && i.getDate() === n && (h = true);
  let d = r.getDay(), T = de[d];
  d === 0 && (d = 7);
  let l = f;
  c = C(f);
  let u = false;
  for (f = 1; f < 13 && o > 0; f++) c > 0 && f === c + 1 && u === false ? (--f, u = true, b = D(l)) : b = L(l, f), u === true && f === c + 1 && (u = false), o -= b;
  o === 0 && c > 0 && f === c + 1 && (u ? u = false : (u = true, --f)), o < 0 && (o += b, --f);
  let s = f, F = o + 1, Ae = t - 1, Fe = h0(l), N = ae(e, t * 2 - 1), Ne = ae(e, t * 2), U = R((e - 1900) * 12 + t + 11);
  n >= N && (U = R((e - 1900) * 12 + t + 12));
  let I = false, M = null;
  N === n && (I = true, M = oe[t * 2 - 2]), Ne === n && (I = true, M = oe[t * 2 - 1]);
  let Ue = Date.UTC(e, Ae, 1, 0, 0, 0, 0) / 864e5 + 25567 + 10, $e = R(Ue + n - 1), Pe = g0(t, n);
  return { lYear: l, lMonth: s, lDay: F, Animal: C0(l), IMonthCn: (u ? "闰" : "") + y0(s), IDayCn: w0(F), cYear: e, cMonth: t, cDay: n, gzYear: Fe, gzMonth: U, gzDay: $e, isToday: h, isLeap: u, nWeek: d, ncWeek: `星期${T}`, isTerm: I, Term: M, astro: Pe };
}
var D0 = { solar2lunar(e, t, n) {
  return ue(e, t, n);
}, lunar2solar(e, t, n, r) {
  ...
  let b = 0;
  for (let s = 1900; s < e; s++) b += le(s);
  let o = 0, i = false;
  for (let s = 1; s < t; s++) o = C(e), i || o <= s && o > 0 && (b += D(e), i = true), b += L(e, s);
  r && (b += f);
  let h = Date.UTC(1900, 1, 30, 0, 0, 0), d = new Date((b + n - 31) * 864e5 + h), T = d.getUTCFullYear(), l = d.getUTCMonth() + 1, u = d.getUTCDate();
  return ue(T, l, u);
} };
var xe = D0;
var { solar2lunar: S0, lunar2solar: E0 } = xe;
function me(e, t) {
  let n = Number(e.split("-")[0]), r = Number(e.split("-")[1]), f = Number(e.split("-")[2]), c;
  return t === "solar" && (c = E0(n, r, f, false)), t === "lunar" && (c = S0(n, r, f)), c === void 0 ? -1 : c;
}
...
export {
  ...
  Le as useRandomHexColor,
  k as useRandomInteger,
  ve as useRandomString,
