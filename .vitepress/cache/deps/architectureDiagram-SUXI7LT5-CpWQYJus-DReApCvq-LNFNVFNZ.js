...
// node_modules/.pnpm/vitepress-plugin-legend@1.0.4_jiti@1.21.7_markmap-common@0.18.9_typescript@5.4.3_yaml@2.8.0/node_modules/vitepress-plugin-legend/dist/architectureDiagram-SUXI7LT5-CpWQYJus-DReApCvq.js
var fe = { exports: {} };
var pe = { exports: {} };
var ve = { exports: {} };
var ui = ve.exports;
      ...
      return (
        ...
        function(_) {
          ...
          function T(u) {
            ...
            return _[u].call(g.exports, g, g.exports, T), g.l = true, g.exports;
          }
          return T.m = _, T.c = k, T.i = function(u) {
            return u;
          }, T.d = function(u, g, o) {
            T.o(u, g) || Object.defineProperty(u, g, {
              /******/
              configurable: false,
              /******/
              enumerable: true,
          ...
          /***/
          function(_, k, T) {
            var u = T(2), g = T(10), o = T(13), i2 = T(0), e2 = T(16), s = T(5);
            function n(t, a, l, d) {
              l == null && d == null && (d = a), u.call(this, d), t.graphManager != null && (t = t.graphManager), this.estimatedSize = g.MIN_VALUE, this.inclusionTreeDepth = g.MAX_VALUE, this.vGraphObject = d, this.edges = [], this.graphManager = t, l != null && a != null ? this.rect = new o(a.x, a.y, l.width, l.height) : this.rect = new o();
            }
            ...
            n.prototype.getEdges = function() {
              ...
              var a = [], l = this;
              return l.edges.forEach(function(d) {
                if (d.target == t) {
                  if (d.source != l) throw "Incorrect edge source!";
                  a.push(d);
                }
              }), a;
              ...
              var a = [], l = this;
              return l.edges.forEach(function(d) {
                if (!(d.source == l || d.target == l)) throw "Incorrect edge source and/or target";
                (d.target == t || d.source == t) && a.push(d);
              }), a;
              ...
              if (t.add(this), this.child != null)
                for (var d = this.child.getNodes(), h = 0; h < d.length; h++)
                  a = d[h], l = a.withChildren(), l.forEach(function(N) {
                    t.add(N);
                  });
              return t;
              ...
              if (this.child == null)
                ...
                for (var l = this.child.getNodes(), d = 0; d < l.length; d++)
                  a = l[d], t += a.getNoOfChildren();
              return t == 0 && (t = 1), t;
            }, n.prototype.getEstimatedSize = function() {
              if (this.estimatedSize == g.MIN_VALUE)
                throw "assert failed";
              return this.estimatedSize;
            }, n.prototype.calcEstimatedSize = function() {
              return this.child == null ? this.estimatedSize = (this.rect.width + this.rect.height) / 2 : (this.estimatedSize = this.child.calcEstimatedSize(), this.rect.width = this.estimatedSize, this.rect.height = this.estimatedSize, this.estimatedSize);
            }, n.prototype.scatter = function() {
              var t, a, l = -i2.INITIAL_WORLD_BOUNDARY, d = i2.INITIAL_WORLD_BOUNDARY;
              t = i2.WORLD_CENTER_X + e2.nextDouble() * (d - l) + l;
              ...
              if (this.inclusionTreeDepth == g.MAX_VALUE)
                throw "assert failed";
              ...
              var d = new s(a, l), h = t.inverseTransformPoint(d);
          ...
          function(_, k, T) {
            ...
            for (var o in u)
              g[o] = u[o];
            g.MAX_ITERATIONS = 2500, g.DEFAULT_EDGE_LENGTH = 50, g.DEFAULT_SPRING_STRENGTH = 0.45, g.DEFAULT_REPULSION_STRENGTH = 4500, g.DEFAULT_GRAVITY_STRENGTH = 0.4, g.DEFAULT_COMPOUND_GRAVITY_STRENGTH = 1, g.DEFAULT_GRAVITY_RANGE_FACTOR = 3.8, g.DEFAULT_COMPOUND_GRAVITY_RANGE_FACTOR = 1.5, g.DEFAULT_USE_SMART_IDEAL_EDGE_LENGTH_CALCULATION = true, g.DEFAULT_USE_SMART_REPULSION_RANGE_CALCULATION = true, g.DEFAULT_COOLING_FACTOR_INCREMENTAL = 0.3, g.COOLING_ADAPTATION_FACTOR = 0.33, g.ADAPTATION_LOWER_NODE_LIMIT = 1e3, g.ADAPTATION_UPPER_NODE_LIMIT = 5e3, g.MAX_NODE_DISPLACEMENT_INCREMENTAL = 100, g.MAX_NODE_DISPLACEMENT = g.MAX_NODE_DISPLACEMENT_INCREMENTAL * 3, g.MIN_REPULSION_DIST = g.DEFAULT_EDGE_LENGTH / 10, g.CONVERGENCE_CHECK_PERIOD = 100, g.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR = 0.1, g.MIN_EDGE_LENGTH = 1, g.GRID_CALCULATION_CHECK_PERIOD = 10, _.exports = g;
          },
          /* 5 */
          /***/
          function(_, k, T) {
            function u(g, o) {
              g == null && o == null ? (this.x = 0, this.y = 0) : (this.x = g, this.y = o);
            }
            u.prototype.getX = function() {
              return this.x;
            }, u.prototype.getY = function() {
              return this.y;
            }, u.prototype.setX = function(g) {
              this.x = g;
            }, u.prototype.setY = function(g) {
              this.y = g;
            }, u.prototype.getDifference = function(g) {
              return new DimensionD(this.x - g.x, this.y - g.y);
            }, u.prototype.getCopy = function() {
              return new u(this.x, this.y);
            }, u.prototype.translate = function(g) {
              return this.x += g.width, this.y += g.height, this;
            }, _.exports = u;
          },
          /* 6 */
          /***/
          function(_, k, T) {
            var u = T(2), g = T(10), o = T(0), i2 = T(7), e2 = T(3), s = T(1), n = T(13), f = T(12), t = T(11);
            function a(d, h, N) {
              u.call(this, N), this.estimatedSize = g.MIN_VALUE, this.margin = o.DEFAULT_GRAPH_MARGIN, this.edges = [], this.nodes = [], this.isConnected = false, this.parent = d, h != null && h instanceof i2 ? this.graphManager = h : h != null && h instanceof Layout && (this.graphManager = h.graphManager);
            }
            ...
            a.prototype.getNodes = function() {
            ...
            }, a.prototype.add = function(d, h, N) {
              if (h == null && N == null) {
                var c = d;
              ...
              for (var d = g.MAX_VALUE, h = g.MAX_VALUE, N, c, y, A = this.getNodes(), I = A.length, P = 0; P < I; P++) {
                var Y = A[P];
                N = Y.getTop(), c = Y.getLeft(), d > N && (d = N), h > c && (h = c);
              }
              return d == g.MAX_VALUE ? null : (A[0].getParent().paddingLeft != null ? y = A[0].getParent().paddingLeft : y = this.margin, this.left = h - y, this.top = d - y, new f(this.left, this.top));
            }, a.prototype.updateBounds = function(d) {
              for (var h = g.MAX_VALUE, N = -g.MAX_VALUE, c = g.MAX_VALUE, y = -g.MAX_VALUE, A, I, P, Y, S2, H = this.nodes, Z = H.length, x = 0; x < Z; x++) {
                var ot = H[x];
                d && ot.child != null && ot.updateBounds(), A = ot.getLeft(), I = ot.getRight(), P = ot.getTop(), Y = ot.getBottom(), h > A && (h = A), N < I && (N = I), c > P && (c = P), y < Y && (y = Y);
              }
              var r = new n(h, c, N - h, y - c);
              h == g.MAX_VALUE && (this.left = this.parent.getLeft(), this.right = this.parent.getRight(), this.top = this.parent.getTop(), this.bottom = this.parent.getBottom()), H[0].getParent().paddingLeft != null ? S2 = H[0].getParent().paddingLeft : S2 = this.margin, this.left = r.x - S2, this.right = r.x + r.width + S2, this.top = r.y - S2, this.bottom = r.y + r.height + S2;
            }, a.calculateBounds = function(d) {
              for (var h = g.MAX_VALUE, N = -g.MAX_VALUE, c = g.MAX_VALUE, y = -g.MAX_VALUE, A, I, P, Y, S2 = d.length, H = 0; H < S2; H++) {
                var Z = d[H];
              ...
              for (var d = 0, h = this.nodes, N = h.length, c = 0; c < N; c++) {
                var y = h[c];
                d += y.calcEstimatedSize();
              }
              return d == 0 ? this.estimatedSize = o.EMPTY_COMPOUND_NODE_SIZE : this.estimatedSize = d / Math.sqrt(this.nodes.length), this.estimatedSize;
              ...
              for (I.forEach(function(x) {
                ...
                for (var P = y.length, Y = 0; Y < P; Y++) {
                  var S2 = y[Y];
                  if (A = S2.getOtherEndInGraph(c, this), A != null && !N.has(A)) {
          ...
          function(_, k, T) {
            ...
            o.prototype.addRoot = function() {
              ...
              if (i2 instanceof u) {
                ...
                var d = this.graphs.indexOf(e2);
                this.graphs.splice(d, 1), e2.parent = null;
          ...
          function(_, k, T) {
            ...
            g.calcSeparationAmount = function(o, i2, e2, s) {
              if (!o.intersects(i2))
                throw "assert failed";
              var n = new Array(2);
            ...
            }, g.decideDirectionsForOverlappingNodes = function(o, i2, e2) {
              o.getCenterX() < i2.getCenterX() ? e2[0] = -1 : e2[0] = 1, o.getCenterY() < i2.getCenterY() ? e2[1] = -1 : e2[1] = 1;
            }, g.getIntersection2 = function(o, i2, e2) {
              var s = o.getCenterX(), n = o.getCenterY(), f = i2.getCenterX(), t = i2.getCenterY();
              if (o.intersects(i2))
                return e2[0] = s, e2[1] = n, e2[2] = f, e2[3] = t, true;
              var a = o.getX(), l = o.getY(), d = o.getRight(), h = o.getX(), N = o.getBottom(), c = o.getRight(), y = o.getWidthHalf(), A = o.getHeightHalf(), I = i2.getX(), P = i2.getY(), Y = i2.getRight(), S2 = i2.getX(), H = i2.getBottom(), Z = i2.getRight(), x = i2.getWidthHalf(), ot = i2.getHeightHalf(), r = false, E = false;
              if (s === f) {
                if (n > t)
                ...
                if (s < f)
                  return e2[0] = d, e2[1] = n, e2[2] = I, e2[3] = t, false;
              } else {
                var p = o.height / o.width, v = i2.height / i2.width, m = (t - n) / (f - s), O = void 0, M = void 0, C = void 0, F = void 0, U = void 0, z = void 0;
                if (-p === m ? s > f ? (e2[0] = h, e2[1] = N, r = true) : (e2[0] = d, e2[1] = l, r = true) : p === m && (s > f ? (e2[0] = a, e2[1] = l, r = true) : (e2[0] = c, e2[1] = N, r = true)), -v === m ? f > s ? (e2[2] = S2, e2[3] = H, E = true) : (e2[2] = Y, e2[3] = P, E = true) : v === m && (f > s ? (e2[2] = I, e2[3] = P, E = true) : (e2[2] = Z, e2[3] = H, E = true)), r && E)
                  return false;
                ...
                if (!E)
                  switch (M) {
                    ...
                    case 3:
                      ...
                      break;
                    case 4:
                      U = S2, z = t + -x * m, e2[2] = U, e2[3] = z;
                      break;
                  }
              }
              return false;
            }, g.getCardinalDirection = function(o, i2, e2) {
              return o > i2 ? e2 : 1 + e2 % 4;
            }, g.getIntersection = function(o, i2, e2, s) {
              if (s == null)
                return this.getIntersection2(o, i2, e2);
              var n = o.x, f = o.y, t = i2.x, a = i2.y, l = e2.x, d = e2.y, h = s.x, N = s.y, c = void 0, y = void 0, A = void 0, I = void 0, P = void 0, Y = void 0, S2 = void 0, H = void 0, Z = void 0;
              return A = a - f, P = n - t, S2 = t * f - n * a, I = N - d, Y = l - h, H = h * d - l * N, Z = A * Y - I * P, Z === 0 ? null : (c = (P * H - Y * S2) / Z, y = (I * S2 - A * H) / Z, new u(c, y));
            }, g.angleOfVector = function(o, i2, e2, s) {
              var n = void 0;
              return o !== e2 ? (n = Math.atan((s - i2) / (e2 - o)), e2 < o ? n += Math.PI : s < i2 && (n += this.TWO_PI)) : s < i2 ? n = this.ONE_AND_HALF_PI : n = this.HALF_PI, n;
            }, g.doIntersect = function(o, i2, e2, s) {
              var n = o.x, f = o.y, t = i2.x, a = i2.y, l = e2.x, d = e2.y, h = s.x, N = s.y, c = (t - n) * (N - d) - (h - l) * (a - f);
              if (c === 0)
                return false;
              var y = ((N - d) * (h - n) + (l - h) * (N - f)) / c, A = ((f - a) * (h - n) + (t - n) * (N - f)) / c;
              return 0 < y && y < 1 && 0 < A && A < 1;
            }, g.findCircleLineIntersections = function(o, i2, e2, s, n, f, t) {
              var a = (e2 - o) * (e2 - o) + (s - i2) * (s - i2), l = 2 * ((o - n) * (e2 - o) + (i2 - f) * (s - i2)), d = (o - n) * (o - n) + (i2 - f) * (i2 - f) - t * t, h = l * l - 4 * a * d;
              if (h >= 0) {
                var N = (-l + Math.sqrt(l * l - 4 * a * d)) / (2 * a), c = (-l - Math.sqrt(l * l - 4 * a * d)) / (2 * a), y = null;
                return N >= 0 && N <= 1 ? [N] : c >= 0 && c <= 1 ? [c] : y;
              } else return null;
            }, g.HALF_PI = 0.5 * Math.PI, g.ONE_AND_HALF_PI = 1.5 * Math.PI, g.TWO_PI = 2 * Math.PI, g.THREE_PI = 3 * Math.PI, _.exports = g;
          },
          /* 9 */
          /***/
          function(_, k, T) {
            ...
            u.sign = function(g) {
              ...
              return g < 0 ? Math.ceil(g) : Math.floor(g);
            }, u.ceil = function(g) {
          ...
          function(_, k, T) {
            ...
            var o = function(n) {
              ...
              function n(f) {
                var t = this;
                g(this, n), this.length = 0, this.head = null, this.tail = null, f == null ? void 0 : f.forEach(function(a) {
                  return t.push(a);
                });
              }
              return u(n, [{
          ...
          function(_, k, T) {
            function u(g, o, i2) {
              this.x = null, this.y = null, g == null && o == null && i2 == null ? (this.x = 0, this.y = 0) : typeof g == "number" && typeof o == "number" && i2 == null ? (this.x = g, this.y = o) : g.constructor.name == "Point" && o == null && i2 == null && (i2 = g, this.x = i2.x, this.y = i2.y);
            }
            u.prototype.getX = function() {
              return this.x;
            }, u.prototype.getY = function() {
              ...
              return new u(this.x, this.y);
            }, u.prototype.setLocation = function(g, o, i2) {
              g.constructor.name == "Point" && o == null && i2 == null ? (i2 = g, this.setLocation(i2.x, i2.y)) : typeof g == "number" && typeof o == "number" && i2 == null && (parseInt(g) == g && parseInt(o) == o ? this.move(g, o) : (this.x = Math.floor(g + 0.5), this.y = Math.floor(o + 0.5)));
            }, u.prototype.move = function(g, o) {
              this.x = g, this.y = o;
            }, u.prototype.translate = function(g, o) {
              this.x += g, this.y += o;
            }, u.prototype.equals = function(g) {
              if (g.constructor.name == "Point") {
                var o = g;
          ...
          /***/
          function(_, k, T) {
            function u(g, o, i2, e2) {
              this.x = 0, this.y = 0, this.width = 0, this.height = 0, g != null && o != null && i2 != null && e2 != null && (this.x = g, this.y = o, this.width = i2, this.height = e2);
            }
            u.prototype.getX = function() {
              return this.x;
            }, u.prototype.setX = function(g) {
              ...
              return this.width;
            }, u.prototype.setWidth = function(g) {
              this.width = g;
            }, u.prototype.getHeight = function() {
              return this.height;
            }, u.prototype.setHeight = function(g) {
              this.height = g;
            }, u.prototype.getRight = function() {
              return this.x + this.width;
            }, u.prototype.getBottom = function() {
              return this.y + this.height;
            }, u.prototype.intersects = function(g) {
              return !(this.getRight() < g.x || this.getBottom() < g.y || g.getRight() < this.x || g.getBottom() < this.y);
          ...
          function(_, k, T) {
            ...
            g.lastID = 0, g.createID = function(o) {
              return g.isPrimitive(o) ? o : (o.uniqueID != null || (o.uniqueID = g.getString(), g.lastID++), o.uniqueID);
            }, g.getString = function(o) {
              return o == null && (o = g.lastID), "Object#" + o;
            }, g.isPrimitive = function(o) {
          ...
          function(_, k, T) {
            function u(l) {
              if (Array.isArray(l)) {
                for (var d = 0, h = Array(l.length); d < l.length; d++)
                  h[d] = l[d];
                return h;
              } else
                return Array.from(l);
            }
            var g = T(0), o = T(7), i2 = T(3), e2 = T(1), s = T(6), n = T(5), f = T(17), t = T(29);
            function a(l) {
              t.call(this), this.layoutQuality = g.QUALITY, this.createBendsAsNeeded = g.DEFAULT_CREATE_BENDS_AS_NEEDED, this.incremental = g.DEFAULT_INCREMENTAL, this.animationOnLayout = g.DEFAULT_ANIMATION_ON_LAYOUT, this.animationDuringLayout = g.DEFAULT_ANIMATION_DURING_LAYOUT, this.animationPeriod = g.DEFAULT_ANIMATION_PERIOD, this.uniformLeafNodeSizes = g.DEFAULT_UNIFORM_LEAF_NODE_SIZES, this.edgeToDummyNodes = /* @__PURE__ */ new Map(), this.graphManager = new o(this), this.isLayoutFinished = false, this.isSubLayout = false, this.isRemoteUse = false, l != null && (this.isRemoteUse = l);
            }
            a.RANDOM_SEED = 1, a.prototype = Object.create(t.prototype), a.prototype.getGraphManager = function() {
              ...
              var l;
              return this.checkLayoutSuccess() ? l = false : l = this.layout(), g.ANIMATE === "during" ? false : (l && (this.isSubLayout || this.doPostLayout()), this.tilingPostLayout && this.tilingPostLayout(), this.isLayoutFinished = true, l);
            }, a.prototype.doPostLayout = function() {
              this.incremental || this.transform(), this.update();
            }, a.prototype.update2 = function() {
              if (this.createBendsAsNeeded && (this.createBendpointsFromDummyNodes(), this.graphManager.resetAllEdges()), !this.isRemoteUse) {
                for (var l = this.graphManager.getAllEdges(), d = 0; d < l.length; d++)
                  l[d];
                for (var h = this.graphManager.getRoot().getNodes(), d = 0; d < h.length; d++)
                  h[d];
              ...
              if (l == null)
                ...
                var d = l;
                if (d.getChild() != null)
                  for (var h = d.getChild().getNodes(), N = 0; N < h.length; N++)
                    update(h[N]);
              ...
              this.isSubLayout || (this.layoutQuality = g.QUALITY, this.animationDuringLayout = g.DEFAULT_ANIMATION_DURING_LAYOUT, this.animationPeriod = g.DEFAULT_ANIMATION_PERIOD, this.animationOnLayout = g.DEFAULT_ANIMATION_ON_LAYOUT, this.incremental = g.DEFAULT_INCREMENTAL, this.createBendsAsNeeded = g.DEFAULT_CREATE_BENDS_AS_NEEDED, this.uniformLeafNodeSizes = g.DEFAULT_UNIFORM_LEAF_NODE_SIZES), this.animationDuringLayout && (this.animationOnLayout = false);
            }, a.prototype.transform = function(l) {
              if (l == null)
                this.transform(new n(0, 0));
              else {
                var d = new f(), h = this.graphManager.getRoot().updateLeftTop();
                if (h != null) {
                  d.setWorldOrgX(l.x), d.setWorldOrgY(l.y), d.setDeviceOrgX(h.x), d.setDeviceOrgY(h.y);
              ...
              if (l == null)
                ...
                for (var d, h, N = l.getNodes(), c = 0; c < N.length; c++)
                  d = N[c], h = d.getChild(), h == null || h.getNodes().length == 0 ? d.scatter() : (this.positionNodesRandomly(h), d.updateBounds());
            }, a.prototype.getFlatForest = function() {
              for (var l = [], d = true, h = this.graphManager.getRoot().getNodes(), N = true, c = 0; c < h.length; c++)
                h[c].getChild() != null && (N = false);
              if (!N)
                return l;
              var y = /* @__PURE__ */ new Set(), A = [], I = /* @__PURE__ */ new Map(), P = [];
              for (P = P.concat(h); P.length > 0 && d; ) {
                for (A.push(P[0]); A.length > 0 && d; ) {
                  var Y = A[0];
                  A.splice(0, 1), y.add(Y);
                  for (var S2 = Y.getEdges(), c = 0; c < S2.length; c++) {
                    var H = S2[c].getOtherEnd(Y);
                    if (I.get(Y) != H)
                      if (!y.has(H))
                        A.push(H), I.set(H, Y);
                      else {
              ...
              for (var d = [], h = l.source, N = this.graphManager.calcLowestCommonAncestor(l.source, l.target), c = 0; c < l.bendpoints.length; c++) {
                var y = this.newNode(null);
                y.setRect(new Point(0, 0), new Dimension(1, 1)), N.add(y);
                var A = this.newEdge(null);
                this.graphManager.add(A, h, y), d.add(y), h = y;
              }
              var A = this.newEdge(null);
              return this.graphManager.add(A, h, l.target), this.edgeToDummyNodes.set(l, d), l.isInterGraph() ? this.graphManager.remove(l) : N.remove(l), d;
              ...
              if (h != null && N != null) {
                ...
                var I, P;
                return l <= 50 ? (I = 9 * d / 500, P = d / 10) : (I = 9 * d / 50, P = -8 * d), I * l + P;
              }
            }, a.findCenterOfTree = function(l) {
              var d = [];
              d = d.concat(l);
              var h = [], N = /* @__PURE__ */ new Map(), c = false, y = null;
              (d.length == 1 || d.length == 2) && (c = true, y = d[0]);
              for (var A = 0; A < d.length; A++) {
                var I = d[A], P = I.getNeighborsList().size;
              ...
              for (Y = Y.concat(h); !c; ) {
                ...
                h = h.concat(Y), (d.length == 1 || d.length == 2) && (c = true, y = d[0]);
              }
              return y;
          ...
          function(_, k, T) {
            ...
            g.prototype.getWorldOrgX = function() {
              return this.lworldOrgX;
            }, g.prototype.setWorldOrgX = function(o) {
              this.lworldOrgX = o;
            }, g.prototype.getWorldOrgY = function() {
              return this.lworldOrgY;
            }, g.prototype.setWorldOrgY = function(o) {
              this.lworldOrgY = o;
            }, g.prototype.getWorldExtX = function() {
              return this.lworldExtX;
            }, g.prototype.setWorldExtX = function(o) {
              this.lworldExtX = o;
            }, g.prototype.getWorldExtY = function() {
              return this.lworldExtY;
            }, g.prototype.setWorldExtY = function(o) {
              this.lworldExtY = o;
            }, g.prototype.getDeviceOrgX = function() {
              return this.ldeviceOrgX;
            }, g.prototype.setDeviceOrgX = function(o) {
              this.ldeviceOrgX = o;
            }, g.prototype.getDeviceOrgY = function() {
              return this.ldeviceOrgY;
            }, g.prototype.setDeviceOrgY = function(o) {
              this.ldeviceOrgY = o;
            }, g.prototype.getDeviceExtX = function() {
              return this.ldeviceExtX;
            }, g.prototype.setDeviceExtX = function(o) {
              this.ldeviceExtX = o;
            }, g.prototype.getDeviceExtY = function() {
              return this.ldeviceExtY;
            }, g.prototype.setDeviceExtY = function(o) {
              this.ldeviceExtY = o;
            }, g.prototype.transformX = function(o) {
              var i2 = 0, e2 = this.lworldExtX;
              return e2 != 0 && (i2 = this.ldeviceOrgX + (o - this.lworldOrgX) * this.ldeviceExtX / e2), i2;
            }, g.prototype.transformY = function(o) {
              var i2 = 0, e2 = this.lworldExtY;
              return e2 != 0 && (i2 = this.ldeviceOrgY + (o - this.lworldOrgY) * this.ldeviceExtY / e2), i2;
            }, g.prototype.inverseTransformX = function(o) {
              var i2 = 0, e2 = this.ldeviceExtX;
              return e2 != 0 && (i2 = this.lworldOrgX + (o - this.ldeviceOrgX) * this.lworldExtX / e2), i2;
            }, g.prototype.inverseTransformY = function(o) {
              var i2 = 0, e2 = this.ldeviceExtY;
              return e2 != 0 && (i2 = this.lworldOrgY + (o - this.ldeviceOrgY) * this.lworldExtY / e2), i2;
            }, g.prototype.inverseTransformPoint = function(o) {
          ...
          function(_, k, T) {
            ...
            var g = T(15), o = T(4), i2 = T(0), e2 = T(8), s = T(9);
            function n() {
              g.call(this), this.useSmartIdealEdgeLengthCalculation = o.DEFAULT_USE_SMART_IDEAL_EDGE_LENGTH_CALCULATION, this.gravityConstant = o.DEFAULT_GRAVITY_STRENGTH, this.compoundGravityConstant = o.DEFAULT_COMPOUND_GRAVITY_STRENGTH, this.gravityRangeFactor = o.DEFAULT_GRAVITY_RANGE_FACTOR, this.compoundGravityRangeFactor = o.DEFAULT_COMPOUND_GRAVITY_RANGE_FACTOR, this.displacementThresholdPerNode = 3 * o.DEFAULT_EDGE_LENGTH / 100, this.coolingFactor = o.DEFAULT_COOLING_FACTOR_INCREMENTAL, this.initialCoolingFactor = o.DEFAULT_COOLING_FACTOR_INCREMENTAL, this.totalDisplacement = 0, this.oldTotalDisplacement = 0, this.maxIterations = o.MAX_ITERATIONS;
            }
            n.prototype = Object.create(g.prototype);
            for (var f in g)
              n[f] = g[f];
            n.prototype.initParameters = function() {
              g.prototype.initParameters.call(this, arguments), this.totalIterations = 0, this.notAnimatedIterations = 0, this.useFRGridVariant = o.DEFAULT_USE_SMART_REPULSION_RANGE_CALCULATION, this.grid = [];
            }, n.prototype.calcIdealEdgeLengths = function() {
              for (var t, a, l, d, h, N, c, y = this.getGraphManager().getAllEdges(), A = 0; A < y.length; A++)
                t = y[A], a = t.idealLength, t.isInterGraph && (d = t.getSource(), h = t.getTarget(), N = t.getSourceInLca().getEstimatedSize(), c = t.getTargetInLca().getEstimatedSize(), this.useSmartIdealEdgeLengthCalculation && (t.idealLength += N + c - 2 * i2.SIMPLE_NODE_SIZE), l = t.getLca().getInclusionTreeDepth(), t.idealLength += a * o.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR * (d.getInclusionTreeDepth() + h.getInclusionTreeDepth() - 2 * l));
              ...
              var t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true, a = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false, l, d, h, N, c = this.getAllNodes(), y;
              if (this.useFRGridVariant)
                ...
                for (l = 0; l < c.length; l++)
                  for (h = c[l], d = l + 1; d < c.length; d++)
                    N = c[d], h.getOwner() == N.getOwner() && this.calcRepulsionForce(h, N);
              ...
              var l = t.getSource(), d = t.getTarget(), h, N, c, y;
              if (this.uniformLeafNodeSizes && l.getChild() == null && d.getChild() == null)
                ...
                return;
              h = t.getLength(), h != 0 && (N = t.edgeElasticity * (h - a), c = N * (t.lengthX / h), y = N * (t.lengthY / h), l.springForceX += c, l.springForceY += y, d.springForceX -= c, d.springForceY -= y);
            }, n.prototype.calcRepulsionForce = function(t, a) {
              var l = t.getRect(), d = a.getRect(), h = new Array(2), N = new Array(4), c, y, A, I, P, Y, S2;
              if (l.intersects(d)) {
                e2.calcSeparationAmount(l, d, h, o.DEFAULT_EDGE_LENGTH / 2), Y = 2 * h[0], S2 = 2 * h[1];
                var H = t.noOfChildren * a.noOfChildren / (t.noOfChildren + a.noOfChildren);
                t.repulsionForceX -= H * Y, t.repulsionForceY -= H * S2, a.repulsionForceX += H * Y, a.repulsionForceY += H * S2;
              } else
                this.uniformLeafNodeSizes && t.getChild() == null && a.getChild() == null ? (c = d.getCenterX() - l.getCenterX(), y = d.getCenterY() - l.getCenterY()) : (e2.getIntersection(l, d, N), c = N[2] - N[0], y = N[3] - N[1]), Math.abs(c) < o.MIN_REPULSION_DIST && (c = s.sign(c) * o.MIN_REPULSION_DIST), Math.abs(y) < o.MIN_REPULSION_DIST && (y = s.sign(y) * o.MIN_REPULSION_DIST), A = c * c + y * y, I = Math.sqrt(A), P = (t.nodeRepulsion / 2 + a.nodeRepulsion / 2) * t.noOfChildren * a.noOfChildren / A, Y = P * c / I, S2 = P * y / I, t.repulsionForceX -= Y, t.repulsionForceY -= S2, a.repulsionForceX += Y, a.repulsionForceY += S2;
            }, n.prototype.calcGravitationalForce = function(t) {
              var a, l, d, h, N, c, y, A;
              a = t.getOwner(), l = (a.getRight() + a.getLeft()) / 2, d = (a.getTop() + a.getBottom()) / 2, h = t.getCenterX() - l, N = t.getCenterY() - d, c = Math.abs(h) + t.getWidth() / 2, y = Math.abs(N) + t.getHeight() / 2, t.getOwner() == this.graphManager.getRoot() ? (A = a.getEstimatedSize() * this.gravityRangeFactor, (c > A || y > A) && (t.gravitationForceX = -this.gravityConstant * h, t.gravitationForceY = -this.gravityConstant * N)) : (A = a.getEstimatedSize() * this.compoundGravityRangeFactor, (c > A || y > A) && (t.gravitationForceX = -this.gravityConstant * h * this.compoundGravityConstant, t.gravitationForceY = -this.gravityConstant * N * this.compoundGravityConstant));
              ...
              for (var d = new Array(a), h = 0; h < a; h++)
                d[h] = new Array(l);
              for (var h = 0; h < a; h++)
                for (var N = 0; N < l; N++)
                  d[h][N] = new Array();
              ...
              var d = 0, h = 0, N = 0, c = 0;
              d = parseInt(Math.floor((t.getRect().x - a) / this.repulsionRange)), h = parseInt(Math.floor((t.getRect().width + t.getRect().x - a) / this.repulsionRange)), N = parseInt(Math.floor((t.getRect().y - l) / this.repulsionRange)), c = parseInt(Math.floor((t.getRect().height + t.getRect().y - l) / this.repulsionRange));
              for (var y = d; y <= h; y++)
                for (var A = N; A <= c; A++)
                  this.grid[y][A].push(t), t.setGridCoordinates(d, h, N, c);
            ...
            }, n.prototype.calculateRepulsionForceOfANode = function(t, a, l, d) {
              if (this.totalIterations % o.GRID_CALCULATION_CHECK_PERIOD == 1 && l || d) {
          ...
          function(_, k, T) {
            var u = T(1), g = T(4);
            function o(e2, s, n) {
              u.call(this, e2, s, n), this.idealLength = g.DEFAULT_EDGE_LENGTH, this.edgeElasticity = g.DEFAULT_SPRING_STRENGTH;
            }
          ...
          function(_, k, T) {
            var u = T(3), g = T(4);
            function o(e2, s, n, f) {
              u.call(this, e2, s, n, f), this.nodeRepulsion = g.DEFAULT_REPULSION_STRENGTH, this.springForceX = 0, this.springForceY = 0, this.repulsionForceX = 0, this.repulsionForceY = 0, this.gravitationForceX = 0, this.gravitationForceY = 0, this.displacementX = 0, this.displacementY = 0, this.startX = 0, this.finishX = 0, this.startY = 0, this.finishY = 0, this.surrounding = [];
            }
            o.prototype = Object.create(u.prototype);
            for (var i2 in u)
              o[i2] = u[i2];
          ...
          function(_, k, T) {
            function u(g, o) {
              this.width = 0, this.height = 0, g !== null && o !== null && (this.height = o, this.width = g);
            }
            u.prototype.getWidth = function() {
              return this.width;
            }, u.prototype.setWidth = function(g) {
          ...
          function(_, k, T) {
            ...
            g.prototype.add = function(o) {
              var i2 = u.createID(o);
              this.contains(i2) || (this.set[i2] = o);
            }, g.prototype.remove = function(o) {
          ...
          function(_, k, T) {
            ...
            u.multMat = function(g, o) {
              for (var i2 = [], e2 = 0; e2 < g.length; e2++) {
                i2[e2] = [];
                for (var s = 0; s < o[0].length; s++) {
                  i2[e2][s] = 0;
                  for (var n = 0; n < g[0].length; n++)
                    i2[e2][s] += g[e2][n] * o[n][s];
                }
              }
              return i2;
            }, u.transpose = function(g) {
              for (var o = [], i2 = 0; i2 < g[0].length; i2++) {
                o[i2] = [];
                for (var e2 = 0; e2 < g.length; e2++)
                  o[i2][e2] = g[e2][i2];
              }
              return o;
            }, u.multCons = function(g, o) {
              for (var i2 = [], e2 = 0; e2 < g.length; e2++)
                i2[e2] = g[e2] * o;
              return i2;
            }, u.minusOp = function(g, o) {
              for (var i2 = [], e2 = 0; e2 < g.length; e2++)
                i2[e2] = g[e2] - o[e2];
              return i2;
            }, u.dotProduct = function(g, o) {
              for (var i2 = 0, e2 = 0; e2 < g.length; e2++)
                i2 += g[e2] * o[e2];
              return i2;
            }, u.mag = function(g) {
              return Math.sqrt(this.dotProduct(g, g));
            }, u.normalize = function(g) {
              for (var o = [], i2 = this.mag(g), e2 = 0; e2 < g.length; e2++)
                o[e2] = g[e2] / i2;
              return o;
            }, u.multGamma = function(g) {
              for (var o = [], i2 = 0, e2 = 0; e2 < g.length; e2++)
                i2 += g[e2];
              i2 *= -1 / g.length;
              for (var s = 0; s < g.length; s++)
                o[s] = i2 + g[s];
              return o;
            }, u.multL = function(g, o, i2) {
          ...
          function(_, k, T) {
            ...
            var o = T(11), i2 = function() {
              function e2(s, n) {
                g(this, e2), (n !== null || n !== void 0) && (this.compareFunction = this._defaultCompareFunction);
                var f = void 0;
          ...
          function(_, k, T) {
            ...
            u.svd = function(g) {
              this.U = null, this.V = null, this.s = null, this.m = 0, this.n = 0, this.m = g.length, this.n = g[0].length;
              ...
              for (var i2 = function(Lt) {
                ...
                if (t < n) {
                  ...
                  for (var a = t; a < this.m; a++)
                    this.s[t] = u.hypot(this.s[t], g[a][t]);
                  if (this.s[t] !== 0) {
                    g[t][t] < 0 && (this.s[t] = -this.s[t]);
              ...
              n < this.n && (this.s[n] = g[n][n]), this.m < r && (this.s[r - 1] = 0), f + 1 < r && (i2[f] = g[f][r - 1]), i2[r - 1] = 0;
              {
                for (var E = n; E < o; E++) {
                  ...
                  case 3:
                    {
                      ...
                      for (var tt = (V + ct) * (V - ct) + lt, dt = V * Q, rt = j; rt < r - 1; rt++) {
                        var Nt = u.hypot(tt, dt), yt = tt / Nt, Ct = dt / Nt;
                        rt !== j && (i2[rt - 1] = Nt), tt = yt * this.s[rt] + Ct * i2[rt], i2[rt] = yt * i2[rt] - Ct * this.s[rt], dt = Ct * this.s[rt + 1], this.s[rt + 1] = yt * this.s[rt + 1];
                        for (var gt = 0; gt < this.n; gt++)
                          Nt = yt * this.V[gt][rt] + Ct * this.V[gt][rt + 1], this.V[gt][rt + 1] = -Ct * this.V[gt][rt] + yt * this.V[gt][rt + 1], this.V[gt][rt] = Nt;
                        if (Nt = u.hypot(tt, dt), yt = tt / Nt, Ct = dt / Nt, this.s[rt] = Nt, tt = yt * i2[rt] + Ct * this.s[rt + 1], this.s[rt + 1] = -Ct * i2[rt] + yt * this.s[rt + 1], dt = Ct * i2[rt + 1], i2[rt + 1] = yt * i2[rt + 1], rt < this.m - 1)
              ...
              return Ut;
            }, u.hypot = function(g, o) {
              var i2 = void 0;
              return Math.abs(g) > Math.abs(o) ? (i2 = o / g, i2 = Math.abs(g) * Math.sqrt(1 + i2 * i2)) : o != 0 ? (i2 = g / o, i2 = Math.abs(o) * Math.sqrt(1 + i2 * i2)) : i2 = 0, i2;
            }, _.exports = u;
          },
          /* 27 */
          /***/
          function(_, k, T) {
            ...
            var o = function() {
              function i2(e2, s) {
                ...
                g(this, i2), this.sequence1 = e2, this.sequence2 = s, this.match_score = n, this.mismatch_penalty = f, this.gap_penalty = t, this.iMax = e2.length + 1, this.jMax = s.length + 1, this.grid = new Array(this.iMax);
                ...
                for (var d = 0; d < this.iMax; d++) {
                  ...
                  for (var h = 0; h < this.jMax; h++)
                    this.tracebackGrid[d][h] = [null, null, null];
                }
                ...
                value: function() {
                  ...
                  for (var n = 1; n < this.iMax; n++)
                    for (var f = 1; f < this.jMax; f++) {
                      ...
                      var a = this.grid[n - 1][f] + this.gap_penalty, l = this.grid[n][f - 1] + this.gap_penalty, d = [t, a, l], h = this.arrayAllMaxIndexes(d);
                      this.grid[n][f] = d[h[0]], this.tracebackGrid[n][f] = [h.includes(0), h.includes(1), h.includes(2)];
                    }
        ...
        (() => {
          var k = {
            ...
            765: (
              /***/
              (o, i2, e2) => {
                var s = e2(551).FDLayout, n = e2(578), f = e2(880), t = e2(991), a = e2(767), l = e2(806), d = e2(902), h = e2(551).FDLayoutConstants, N = e2(551).LayoutConstants, c = e2(551).Point, y = e2(551).PointD, A = e2(551).DimensionD, I = e2(551).Layout, P = e2(551).Integer, Y = e2(551).IGeometry, S2 = e2(551).LGraph, H = e2(551).Transform, Z = e2(551).LinkedList;
                function x() {
                ...
                x.prototype.newGraphManager = function() {
                  ...
                  return Object.keys(this.constraints).length > 0 && (d.handleConstraints(this), this.initConstraintVariables()), this.initSpringEmbedder(), l.APPLY_LAYOUT && this.runSpringEmbedder(), true;
                  ...
                  var m = S2.calculateBounds(r), O = new H();
            ...
            991: (
              ...
              (o, i2, e2) => {
                ...
                f.prototype.calculateDisplacement = function() {
                  ...
                  for (var d = this.getChild().getNodes(), h, N = 0; N < d.length; N++)
                    h = d[N], h.getChild() == null ? (h.displacementX += a, h.displacementY += l) : h.propogateDisplacementToChildren(a, l);
            ...
            902: (
              ...
              (o, i2, e2) => {
                function s(d) {
                  if (Array.isArray(d)) {
                    for (var h = 0, N = Array(d.length); h < d.length; h++)
                      N[h] = d[h];
                    return N;
                  } else
                    return Array.from(d);
                ...
                l.handleConstraints = function(d) {
                  var h = {};
                  h.fixedNodeConstraint = d.constraints.fixedNodeConstraint, h.alignmentConstraint = d.constraints.alignmentConstraint, h.relativePlacementConstraint = d.constraints.relativePlacementConstraint;
                  for (var N = /* @__PURE__ */ new Map(), c = /* @__PURE__ */ new Map(), y = [], A = [], I = d.getAllNodes(), P = 0, Y = 0; Y < I.length; Y++) {
                    var S2 = I[Y];
                    S2.getChild() == null && (c.set(S2.id, P++), y.push(S2.getCenterX()), A.push(S2.getCenterY()), N.set(S2.id, S2));
                  }
                  ...
                  var H = function(L, R) {
                    ...
                    function pt(gt, at) {
                      var st = new Set(gt), It = true, ut2 = false, Ot = void 0;
                      try {
                    ...
                    var tt = /* @__PURE__ */ new Map(), dt = /* @__PURE__ */ new Map(), rt = new f();
                    lt.forEach(function(gt, at) {
                      gt == 0 ? (rt.push(at), V || (R == "horizontal" ? tt.set(at, c.has(at) ? y[c.get(at)] : Q.get(at)) : tt.set(at, c.has(at) ? A[c.get(at)] : Q.get(at)))) : tt.set(at, Number.NEGATIVE_INFINITY), V && dt.set(at, /* @__PURE__ */ new Set([at]));
                    }), V && K.forEach(function(gt) {
                      var at = [];
                      if (gt.forEach(function(ut2) {
                        V.has(ut2) && at.push(ut2);
                      }), at.length > 0) {
                        var st = 0;
                        at.forEach(function(ut2) {
                          R == "horizontal" ? (tt.set(ut2, c.has(ut2) ? y[c.get(ut2)] : Q.get(ut2)), st += tt.get(ut2)) : (tt.set(ut2, c.has(ut2) ? A[c.get(ut2)] : Q.get(ut2)), st += tt.get(ut2));
                        }), st = st / at.length, gt.forEach(function(ut2) {
                          V.has(ut2) || tt.set(ut2, st);
                        });
                      } else {
                        var It = 0;
                        gt.forEach(function(ut2) {
                          R == "horizontal" ? It += c.has(ut2) ? y[c.get(ut2)] : Q.get(ut2) : It += c.has(ut2) ? A[c.get(ut2)] : Q.get(ut2);
                        }), It = It / gt.length, gt.forEach(function(ut2) {
                          tt.set(ut2, It);
                        });
                      }
                    });
                    for (var Nt = function() {
                      var gt = rt.shift(), at = L.get(gt);
                      at.forEach(function(st) {
                        if (tt.get(st.id) < tt.get(gt) + st.gap)
                          if (V && V.has(st.id)) {
                            var It = void 0;
                            if (R == "horizontal" ? It = c.has(st.id) ? y[c.get(st.id)] : Q.get(st.id) : It = c.has(st.id) ? A[c.get(st.id)] : Q.get(st.id), tt.set(st.id, It), It < tt.get(gt) + st.gap) {
                              var ut2 = tt.get(gt) + st.gap - It;
                              dt.get(gt).forEach(function(Ot) {
                                tt.set(Ot, tt.get(Ot) - ut2);
                              });
                            }
                          } else
                            tt.set(st.id, tt.get(gt) + st.gap);
                        lt.set(st.id, lt.get(st.id) - 1), lt.get(st.id) == 0 && rt.push(st.id), V && dt.set(st.id, pt(dt.get(gt), dt.get(st.id)));
                      });
                    }; rt.length != 0; )
                      Nt();
                    if (V) {
                      ...
                      L.forEach(function(gt, at) {
                        gt.length == 0 && yt.add(at);
                      });
                      var Ct = [];
                      dt.forEach(function(gt, at) {
                        if (yt.has(at)) {
                          var st = false, It = true, ut2 = false, Ot = void 0;
                          try {
                            for (var Ut = gt[Symbol.iterator](), Lt; !(It = (Lt = Ut.next()).done); It = true) {
                              var At = Lt.value;
                              V.has(At) && (st = true);
                            }
                          } catch (Rt) {
                          ...
                          if (!st) {
                            ...
                            Ct.forEach(function(Rt, kt) {
                              Rt.has([].concat(s(gt))[0]) && (Ht = true, Yt = kt);
                            }), Ht ? gt.forEach(function(Rt) {
                              Ct[Yt].add(Rt);
                            }) : Ct.push(new Set(gt));
                          }
                        }
                      }), Ct.forEach(function(gt, at) {
                        ...
                        try {
                          for (var Ht = gt[Symbol.iterator](), Yt; !(Ut = (Yt = Ht.next()).done); Ut = true) {
                        ...
                        try {
                          for (var $t = gt[Symbol.iterator](), te; !(re = (te = $t.next()).done); re = true) {
                            var oe = te.value;
                    ...
                    var R = 0, V = 0, Q = 0, K = 0;
                    if (L.forEach(function(dt) {
                      dt.left ? y[c.get(dt.left)] - y[c.get(dt.right)] >= 0 ? R++ : V++ : A[c.get(dt.top)] - A[c.get(dt.bottom)] >= 0 ? Q++ : K++;
                    }), R > V && Q > K)
                      ...
                      (function() {
                        ...
                        if (h.alignmentConstraint.vertical) {
                          for (var R = h.alignmentConstraint.vertical, V = function(tt) {
                            ...
                            var rt = new Set([].concat(s(dt)).filter(function(yt) {
                              return C.has(yt);
                            })), Nt = void 0;
                            rt.size > 0 ? Nt = y[c.get(rt.values().next().value)] : Nt = Z(dt).x, R[tt].forEach(function(yt) {
                        ...
                        if (h.alignmentConstraint.horizontal) {
                          for (var K = h.alignmentConstraint.horizontal, pt = function(tt) {
                            ...
                            rt.size > 0 ? Nt = y[c.get(rt.values().next().value)] : Nt = Z(dt).y, K[tt].forEach(function(yt) {
                  ...
                  if (n.ENFORCE_CONSTRAINTS) {
                    ...
                    h.relativePlacementConstraint && function() {
                      ...
                      if (C.forEach(function(ft) {
                        ...
                        if (h.alignmentConstraint.vertical)
                          for (var dt = h.alignmentConstraint.vertical, rt = function(ft) {
                            V.set("dummy" + ft, []), dt[ft].forEach(function(xt) {
                              L.set(xt, "dummy" + ft), V.get("dummy" + ft).push(xt), C.has(xt) && lt.add("dummy" + ft);
                            }), K.set("dummy" + ft, y[c.get(dt[ft][0])]);
                          }, Nt = 0; Nt < dt.length; Nt++)
                            rt(Nt);
                        if (h.alignmentConstraint.horizontal)
                      ...
                      try {
                        for (var de = te.keys()[Symbol.iterator](), Me; !(ce = (Me = de.next()).done); ce = true) {
                          var ge = Me.value;
                          je(ge);
                        }
                      } catch (ft) {
        ...
        (() => {
          var k = {
            ...
            548: (
              ...
              (o, i2, e2) => {
                var s = /* @__PURE__ */ function() {
                  function t(a, l) {
                    var d = [], h = true, N = false, c = void 0;
                    try {
                      for (var y = a[Symbol.iterator](), A; !(h = (A = y.next()).done) && (d.push(A.value), !(l && d.length === l)); h = true)
                        ;
                    } catch (I) {
                      N = true, c = I;
                    } finally {
                ...
                f.getTopMostNodes = function(t) {
                  ...
                  return d;
                }, f.connectComponents = function(t, a, l, d) {
                  var h = new n(), N = /* @__PURE__ */ new Set(), c = [], y = void 0, A = void 0, I = void 0, P = false, Y = 1, S2 = [], H = [], Z = function() {
                    var x = t.collection();
                    H.push(x);
                  ...
                  if (!l.fixedNodeConstraint) {
                    ...
                    if (l.quality == "draft") {
                      ...
                      Object.keys(a).forEach(function(U) {
                        ...
                        W < d && (d = W), B > h && (h = B), $ < N && (N = $), G > c && (c = G);
                      });
                      var C = t.x - (h + d) / 2, F = t.y - (c + N) / 2;
                      Object.keys(a).forEach(function(U) {
                        var z = a[U];
                ...
                }, f.calcBoundingBox = function(t, a, l, d) {
                  for (var h = Number.MAX_SAFE_INTEGER, N = Number.MIN_SAFE_INTEGER, c = Number.MAX_SAFE_INTEGER, y = Number.MIN_SAFE_INTEGER, A = void 0, I = void 0, P = void 0, Y = void 0, S2 = t.descendants().not(":parent"), H = S2.length, Z = 0; Z < H; Z++) {
                    var x = S2[Z];
                    A = a[d.get(x.id())] - x.width() / 2, I = a[d.get(x.id())] + x.width() / 2, P = l[d.get(x.id())] - x.height() / 2, Y = l[d.get(x.id())] + x.height() / 2, h > A && (h = A), N < I && (N = I), c > P && (c = P), y < Y && (y = Y);
                  }
                  var ot = {};
                  return ot.topLeftX = h, ot.topLeftY = c, ot.width = N - h, ot.height = y - c, ot;
                }, f.calcParentsWithoutChildren = function(t, a) {
                  var l = t.collection();
                  return a.nodes(":parent").forEach(function(d) {
                    var h = false;
            ...
            816: (
              /***/
              (o, i2, e2) => {
                var s = e2(548), n = e2(140).CoSELayout, f = e2(140).CoSENode, t = e2(140).layoutBase.PointD, a = e2(140).layoutBase.DimensionD, l = e2(140).layoutBase.LayoutConstants, d = e2(140).layoutBase.FDLayoutConstants, h = e2(140).CoSEConstants, N = function(c, y) {
                  var A = c.cy, I = c.eles, P = I.nodes(), Y = I.edges(), S2 = void 0, H = void 0, Z = void 0, x = {};
                  c.randomize && (S2 = y.nodeIndexes, H = y.xCoords, Z = y.yCoords);
                  var ot = function(C) {
                    ...
                    for (var B = U.length, $ = 0; $ < B; $++) {
                      ...
                      if (G.outerWidth() != null && G.outerHeight() != null)
                        if (W.randomize)
                          if (!G.isParent())
                            b = F.add(new f(z.graphManager, new t(H[S2.get(G.id())] - q.w / 2, Z[S2.get(G.id())] - q.h / 2), new a(parseFloat(q.w), parseFloat(q.h))));
                          else {
                            var et = s.calcBoundingBox(G, H, Z, S2);
                    ...
                    c.idealEdgeLength != null && (W > 0 ? h.DEFAULT_EDGE_LENGTH = d.DEFAULT_EDGE_LENGTH = z / W : ot(c.idealEdgeLength) ? h.DEFAULT_EDGE_LENGTH = d.DEFAULT_EDGE_LENGTH = 50 : h.DEFAULT_EDGE_LENGTH = d.DEFAULT_EDGE_LENGTH = c.idealEdgeLength, h.MIN_REPULSION_DIST = d.MIN_REPULSION_DIST = d.DEFAULT_EDGE_LENGTH / 10, h.DEFAULT_RADIAL_SEPARATION = d.DEFAULT_EDGE_LENGTH);
                  }, m = function(C, F) {
                  ...
                  c.nestingFactor != null && (h.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR = d.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR = c.nestingFactor), c.gravity != null && (h.DEFAULT_GRAVITY_STRENGTH = d.DEFAULT_GRAVITY_STRENGTH = c.gravity), c.numIter != null && (h.MAX_ITERATIONS = d.MAX_ITERATIONS = c.numIter), c.gravityRange != null && (h.DEFAULT_GRAVITY_RANGE_FACTOR = d.DEFAULT_GRAVITY_RANGE_FACTOR = c.gravityRange), c.gravityCompound != null && (h.DEFAULT_COMPOUND_GRAVITY_STRENGTH = d.DEFAULT_COMPOUND_GRAVITY_STRENGTH = c.gravityCompound), c.gravityRangeCompound != null && (h.DEFAULT_COMPOUND_GRAVITY_RANGE_FACTOR = d.DEFAULT_COMPOUND_GRAVITY_RANGE_FACTOR = c.gravityRangeCompound), c.initialEnergyOnIncremental != null && (h.DEFAULT_COOLING_FACTOR_INCREMENTAL = d.DEFAULT_COOLING_FACTOR_INCREMENTAL = c.initialEnergyOnIncremental), c.tilingCompareBy != null && (h.TILING_COMPARE_BY = c.tilingCompareBy), c.quality == "proof" ? l.QUALITY = 2 : l.QUALITY = 0, h.NODE_DIMENSIONS_INCLUDE_LABELS = d.NODE_DIMENSIONS_INCLUDE_LABELS = l.NODE_DIMENSIONS_INCLUDE_LABELS = c.nodeDimensionsIncludeLabels, h.DEFAULT_INCREMENTAL = d.DEFAULT_INCREMENTAL = l.DEFAULT_INCREMENTAL = !c.randomize, h.ANIMATE = d.ANIMATE = l.ANIMATE = c.animate, h.TILE = c.tile, h.TILING_PADDING_VERTICAL = typeof c.tilingPaddingVertical == "function" ? c.tilingPaddingVertical.call() : c.tilingPaddingVertical, h.TILING_PADDING_HORIZONTAL = typeof c.tilingPaddingHorizontal == "function" ? c.tilingPaddingHorizontal.call() : c.tilingPaddingHorizontal, h.DEFAULT_INCREMENTAL = d.DEFAULT_INCREMENTAL = l.DEFAULT_INCREMENTAL = true, h.PURE_INCREMENTAL = !c.randomize, l.DEFAULT_UNIFORM_LEAF_NODE_SIZES = c.uniformNodeDimensions, c.step == "transformed" && (h.TRANSFORM_ON_CONSTRAINT_HANDLING = true, h.ENFORCE_CONSTRAINTS = false, h.APPLY_LAYOUT = false), c.step == "enforced" && (h.TRANSFORM_ON_CONSTRAINT_HANDLING = false, h.ENFORCE_CONSTRAINTS = true, h.APPLY_LAYOUT = false), c.step == "cose" && (h.TRANSFORM_ON_CONSTRAINT_HANDLING = false, h.ENFORCE_CONSTRAINTS = false, h.APPLY_LAYOUT = true), c.step == "all" && (c.randomize ? h.TRANSFORM_ON_CONSTRAINT_HANDLING = true : h.TRANSFORM_ON_CONSTRAINT_HANDLING = false, h.ENFORCE_CONSTRAINTS = true, h.APPLY_LAYOUT = true), c.fixedNodeConstraint || c.alignmentConstraint || c.relativePlacementConstraint ? h.TREE_REDUCTION_ON_INCREMENTAL = false : h.TREE_REDUCTION_ON_INCREMENTAL = true;
            ...
            212: (
              ...
              (o, i2, e2) => {
                ...
                var f = e2(658), t = e2(548), a = e2(657), l = a.spectralLayout, d = e2(816), h = d.coseLayout, N = Object.freeze({
                  ...
                  return s(y, [{
                    key: "run",
                    value: function() {
                      var A = this, I = this.options, P = I.cy, Y = I.eles, S2 = [], H = [], Z = void 0, x = [];
                      ...
                      if (P.layoutUtilities && I.packComponents && (r = P.layoutUtilities("get"), r || (r = P.layoutUtilities()), E = true), Y.nodes().length > 0)
                        if (E) {
                          ...
                          if (Z = t.connectComponents(P, I.eles, p), Z.forEach(function(J) {
                            ...
                            if (I.tile) {
                              ...
                              if (Z.forEach(function(J, nt) {
                                ...
                                var z = v.boundingBox();
                                x.push({ x: z.x1 + z.w / 2, y: z.y1 + z.h / 2 }), Z.push(v), S2.push(F);
                                for (var W = U.length - 1; W >= 0; W--)
                                  Z.splice(U[W], 1), S2.splice(U[W], 1), x.splice(U[W], 1);
                              }
                            }
                            Z.forEach(function(J, nt) {
                              I.eles = J, H.push(h(I, S2[nt])), t.relocateComponent(x[nt], H[nt], I);
                            });
                          } else
                            Z.forEach(function(J, nt) {
                              t.relocateComponent(x[nt], S2[nt], I);
                            });
                          ...
                          if (Z.length > 1) {
                            ...
                            Z.forEach(function(J, nt) {
                              var mt = void 0;
                              if (I.quality == "draft" && (mt = S2[nt].nodeIndexes), J.nodes().not(G).length > 0) {
                                var ht = {};
                                ht.edges = [], ht.nodes = [];
                                var _t = void 0;
                                J.nodes().not(G).forEach(function(Mt) {
                                  if (I.quality == "draft")
                                    if (!Mt.isParent())
                                      _t = mt.get(Mt.id()), ht.nodes.push({ x: S2[nt].xCoords[_t] - Mt.boundingbox().w / 2, y: S2[nt].yCoords[_t] - Mt.boundingbox().h / 2, width: Mt.boundingbox().w, height: Mt.boundingbox().h });
                                    else {
                                      var Tt = t.calcBoundingBox(Mt, S2[nt].xCoords, S2[nt].yCoords, mt);
                                  ...
                                  if (Tt.css("display") != "none" && wt.css("display") != "none")
                                    if (I.quality == "draft") {
                                      ...
                                      if (Tt.isParent()) {
                                        var zt = t.calcBoundingBox(Tt, S2[nt].xCoords, S2[nt].yCoords, mt);
                                        Pt.push(zt.topLeftX + zt.width / 2), Pt.push(zt.topLeftY + zt.height / 2);
                                      } else
                                        Pt.push(S2[nt].xCoords[Wt]), Pt.push(S2[nt].yCoords[Wt]);
                                      if (wt.isParent()) {
                                        var Gt = t.calcBoundingBox(wt, S2[nt].xCoords, S2[nt].yCoords, mt);
                                        St.push(Gt.topLeftX + Gt.width / 2), St.push(Gt.topLeftY + Gt.height / 2);
                                      } else
                                        St.push(S2[nt].xCoords[bt]), St.push(S2[nt].yCoords[bt]);
                          ...
                          I.quality == "default" || I.quality == "proof" ? (H.push(h(I, S2[0])), t.relocateComponent(x[0], H[0], I)) : t.relocateComponent(x[0], S2[0], I);
                        }
            ...
            657: (
              ...
              (o, i2, e2) => {
                var s = e2(548), n = e2(140).layoutBase.Matrix, f = e2(140).layoutBase.SVD, t = function(a) {
                  var l = a.cy, d = a.eles, h = d.nodes(), N = d.nodes(":parent"), c = /* @__PURE__ */ new Map(), y = /* @__PURE__ */ new Map(), A = /* @__PURE__ */ new Map(), I = [], P = [], Y = [], S2 = [], H = [], Z = [], x = [], ot = [], r = void 0, E = 1e8, p = 1e-9, v = a.piTol, m = a.samplingType, O = a.nodeSeparation, M = void 0, C = function() {
                    ...
                    for (var V = [], Q = 0, K = 0, pt = 0, lt = void 0, tt = [], dt = 0, rt = 1, Nt = 0; Nt < r; Nt++)
                      tt[Nt] = E;
                    ...
                    if (R) {
                      for (var gt = 0; gt < r; gt++)
                        Z[gt][L] < H[gt] && (H[gt] = Z[gt][L]);
                      for (var at = 0; at < r; at++)
                        H[at] > dt && (dt = H[at], rt = at);
                    }
                    return rt;
                  }, U = function(ct) {
                    var L = void 0;
                    ...
                    for (var lt = p, tt = p, dt = void 0; ; ) {
                      for (var rt = 0; rt < r; rt++)
                        Q[rt] = R[rt];
                      if (R = n.multGamma(n.multL(n.multGamma(Q), Z, ot)), ct = n.dotProduct(Q, R), R = n.normalize(R), lt = n.dotProduct(Q, R), dt = Math.abs(lt / tt), dt <= 1 + v && dt >= 1)
                        break;
                      tt = lt;
                    }
                    ...
                    for (tt = p; ; ) {
                      for (var yt = 0; yt < r; yt++)
                        K[yt] = V[yt];
                      if (K = n.minusOp(K, n.multCons(Q, n.dotProduct(Q, K))), V = n.multGamma(n.multL(n.multGamma(K), Z, ot)), L = n.dotProduct(K, V), V = n.normalize(V), lt = n.dotProduct(K, V), dt = Math.abs(lt / tt), dt <= 1 + v && dt >= 1)
                        break;
                      tt = lt;
                    }
                  ...
                  s.connectComponents(l, d, s.getTopMostNodes(h), c), N.forEach(function(ct) {
                    s.connectComponents(l, d, s.getTopMostNodes(ct.descendants().intersection(d)), c);
                  });
                  ...
                  N.forEach(function(ct) {
                    for (var L = ct.children().intersection(d); L.nodes(":childless").length == 0; )
                      L = L.nodes()[0].children().intersection(d);
                    ...
                    ct.isParent() ? L = y.get(A.get(ct.id())) : L = y.get(ct.id()), ct.neighborhood().nodes().forEach(function(R) {
                      d.intersection(ct.edgesWith(R)).length > 0 && (R.isParent() ? I[L].push(A.get(R.id())) : I[L].push(R.id()));
                    });
                  });
                  var Dt = function(ct) {
...
var Re = {
  L: S((w) => `${w},${w / 2} 0,${w} 0,0`, "L"),
  R: S((w) => `0,${w / 2} ${w},0 ${w},${w}`, "R"),
  T: S((w) => `0,0 ${w},0 ${w / 2},${w}`, "T"),
  B: S((w) => `${w / 2},0 ${w},${w} 0,${w}`, "B")
};
var ae2 = {
  L: S((w, X) => w - X + 2, "L"),
  R: S((w, X) => w - 2, "R"),
...
var me2 = S(function(w, X) {
  const _ = `${w}${X}`;
  return wi(_) ? _ : void 0;
}, "getArchitectureDirectionPair");
var Ii = S(function([w, X], _) {
  const k = _[0], T = _[1];
...
var Fe = S((w) => w.data(), "edgeData");
var ie = S((w) => w.data(), "nodeData");
var Se = tw.architecture;
var Et = new e(() => ({
  nodes: {},
  groups: {},
  edges: [],
...
var Oi = S(() => Object.values(Et.records.nodes).filter(Mi), "getServices");
var Ri = S(function({ id: w, in: X }) {
  Et.records.registeredIds[w] = "node", Et.records.nodes[w] = {
    id: w,
    type: "junction",
    edges: [],
...
var bi = S(() => Object.values(Et.records.nodes).filter(xi), "getJunctions");
var Pi = S(() => Object.values(Et.records.nodes), "getNodes");
var ye = S((w) => Et.records.nodes[w], "getNode");
var Gi = S(function({ id: w, icon: X, in: _, title: k }) {
  if (Et.records.registeredIds[w] !== void 0)
    throw new Error(
...
var Fi = S(() => Object.values(Et.records.groups), "getGroups");
var Si = S(function({
  lhsId: w,
  rhsId: X,
  lhsDir: _,
...
var Ui = S(() => Et.records.edges, "getEdges");
var ki = S(() => {
  if (Et.records.dataStructures === void 0) {
    const w = {}, X = Object.entries(Et.records.nodes).reduce((o, [i2, e2]) => (o[i2] = e2.edges.reduce((s, n) => {
      ...
      if (n.lhsId === i2) {
        const a = me2(n.lhsDir, n.rhsDir);
        a && (s[a] = n.rhsId);
      } else {
        const a = me2(n.rhsDir, n.lhsDir);
        a && (s[a] = n.lhsId);
      }
      return s;
...
var Xi = S((w) => Et.records.elements[w], "getElementById");
var Ue = S(() => pg({
  ...Se,
  ...Vr().architecture
}), "getConfig");
...
`, "getStyles");
var zi = Wi;
var ee = S((w) => `<g><rect width="80" height="80" style="fill: #087ebf; stroke-width: 0px;"/>${w}</g>`, "wrapIcon");
var ne = {
...
var Vi = S(async function(w, X) {
  const _ = Ft("padding"), k = Ft("iconSize"), T = k / 2, u = k / 6, g = u / 2;
  await Promise.all(
    X.edges().map(async (o) => {
      var _a, _b;
      const {
      ...
      if (n && (Xt(e2) ? h += e2 === "L" ? -P : P : N += e2 === "T" ? -P : P + 18), l && (Xt(t) ? A += t === "L" ? -P : P : I += t === "T" ? -P : P + 18), !n && ((_a = se.getNode(i2)) == null ? void 0 : _a.type) === "junction" && (Xt(e2) ? h += e2 === "L" ? T : -T : N += e2 === "T" ? T : -T), !l && ((_b = se.getNode(f)) == null ? void 0 : _b.type) === "junction" && (Xt(t) ? A += t === "L" ? T : -T : I += t === "T" ? T : -T), o[0]._private.rscratch) {
        ...
        if (Y.insert("path").attr("d", `M ${h},${N} L ${c},${y} L${A},${I} `).attr("class", "edge"), s) {
          const S2 = Xt(e2) ? ae2[e2](h, u) : h - g, H = qt(e2) ? ae2[e2](N, u) : N - g;
          Y.insert("polygon").attr("points", Re[e2](u)).attr("transform", `translate(${S2},${H})`).attr("class", "arrow");
        }
        if (a) {
          const S2 = Xt(t) ? ae2[t](A, u) : A - g, H = qt(t) ? ae2[t](I, u) : I - g;
          Y.insert("polygon").attr("points", Re[t](u)).attr("transform", `translate(${S2},${H})`).attr("class", "arrow");
        }
        if (d) {
          const S2 = Te(e2, t) ? "XY" : Xt(e2) ? "X" : "Y";
          let H = 0;
          S2 === "X" ? H = Math.abs(h - A) : S2 === "Y" ? H = Math.abs(N - I) / 1.5 : H = Math.abs(h - A) / 2;
          const Z = Y.append("g");
          if (await ys(
            Z,
            d,
            ...
            me()
          ), Z.attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle"), S2 === "X")
    ...
    X.nodes().map(async (u) => {
      ...
      if (g.type === "group") {
        ...
        if (g.icon) {
          const a = n.append("g");
          a.html(
            `<g>${await bc(g.icon, { height: _, width: _, fallbackPrefix: ne.prefix })}</g>`
          ), a.attr(
            "transform",
...
var qi = S(async function(w, X, _) {
  for (const k of _) {
    ...
    if (k.icon)
      g.html(
        `<g>${await bc(k.icon, { height: u, width: u, fallbackPrefix: ne.prefix })}</g>`
      );
    else if (k.iconText) {
      g.html(
        `<g>${await bc("blank", { height: u, width: u, fallbackPrefix: ne.prefix })}</g>`
      );
      const e2 = g.append("g").append("foreignObject").attr("width", u).attr("height", u).append("div").attr("class", "node-icon-text").attr("style", `height: ${u}px;`).append("div").html(k.iconText), s = parseInt(
      ...
      g.append("path").attr("class", "node-bkg").attr("id", "node-" + k.id).attr(
        "d",
...
var $i = S(function(w, X, _) {
  _.forEach((k) => {
    ...
    const { width: g, height: o } = T._groups[0][0].getBBox();
    T.width = g, T.height = o, w.setElementForId(k.id, T);
  });
}, "drawJunctions");
sK([
  {
...
function Be(w, X) {
  w.forEach((_) => {
    const { lhsId: k, rhsId: T, lhsInto: u, lhsGroup: g, rhsInto: o, lhsDir: i2, rhsDir: e2, rhsGroup: s, title: n } = _, f = Te(_.lhsDir, _.rhsDir) ? "segments" : "straight", t = {
      id: `${k}-${T}`,
      label: n,
      source: k,
      sourceDir: i2,
...
S(Be, "addEdges");
function We(w, X, _) {
  const k = S((o, i2) => Object.entries(o).reduce(
    (e2, [s, n]) => {
      var _a;
      let f = 0;
      ...
      for (let a = 0; a < t.length - 1; a++)
        for (let l = a + 1; l < t.length; l++) {
          const [d, h] = t[a], [N, c] = t[l];
          if (((_a = _[d]) == null ? void 0 : _a[N]) === i2)
            e2[s] ?? (e2[s] = []), e2[s] = [...e2[s], ...h, ...c];
          else if (d === "default" || N === "default")
            e2[s] ?? (e2[s] = []), e2[s] = [...e2[s], ...h, ...c];
          else {
            const y = `${s}-${f++}`;
            e2[y] = h;
...
S(We, "getAlignments");
function ze(w) {
  const X = [], _ = S((T) => `${T[0]},${T[1]}`, "posToStr"), k = S((T) => T.split(",").map((u) => parseInt(u)), "strToPos");
  return w.forEach((T) => {
...
S(ze, "getRelativeConstraints");
function Ve(w, X, _, k, T, { spatialMaps: u, groupAlignments: g }) {
  return new Promise((o) => {
    ...
    const s = We(T, u, g), n = ze(u), f = e2.layout({
      name: "fcose",
      quality: "proof",
      styleEnabled: false,
      animate: false,
      ...
      idealEdgeLength(t) {
        const [a, l] = t.connectedNodes(), { parent: d } = ie(a), { parent: h } = ie(l);
        return d === h ? 1.5 * Ft("iconSize") : 0.5 * Ft("iconSize");
      },
      edgeElasticity(t) {
        const [a, l] = t.connectedNodes(), { parent: d } = ie(a), { parent: h } = ie(l);
        return d === h ? 0.45 : 1e-3;
      },
    ...
    f.one("layoutstop", () => {
      ...
      function t(a, l, d, h) {
        ...
        c = (h - A + (y - d) * (A - P) / (y - I)) / Math.sqrt(1 + Math.pow((A - P) / (y - I), 2)), N = Math.sqrt(Math.pow(h - A, 2) + Math.pow(d - y, 2) - Math.pow(c, 2));
        const Y = Math.sqrt(Math.pow(I - y, 2) + Math.pow(P - A, 2));
        N = N / Y;
        let S2 = (I - y) * (h - A) - (P - A) * (d - y);
        switch (true) {
          case S2 >= 0:
            S2 = 1;
            break;
        ...
        return c = Math.abs(c) * S2, N = N * H, {
          distances: c,
          weights: N
        };
      }
      S(t, "getSegmentWeights"), e2.startBatch();
      for (const a of Object.values(e2.edges()))
        if ((_a = a.data) == null ? void 0 : _a.call(a)) {
          const { x: l, y: d } = a.source().position(), { x: h, y: N } = a.target().position();
          if (l !== h && d !== N) {
            const c = a.sourceEndpoint(), y = a.targetEndpoint(), { sourceDir: A } = Fe(a), [I, P] = qt(A) ? [c.x, y.y] : [y.x, c.y], { weights: Y, distances: S2 } = t(c, y, I, P);
            a.style("segment-distances", S2), a.style("segment-weights", Y);
          }
        }
      e2.endBatch(), f.run();
    }), f.run(), e2.ready((t) => {
...
S(Ve, "layoutArchitecture");
var Ki = S(async (w, X, _, k) => {
  const T = k.db, u = T.getServices(), g = T.getJunctions(), o = T.getGroups(), i2 = T.getEdges(), e2 = T.getDataStructures(), s = TZ(X), n = s.append("g");
  n.attr("class", "architecture-edges");
  const f = s.append("g");
  f.attr("class", "architecture-services");
  const t = s.append("g");
  t.attr("class", "architecture-groups"), await qi(T, f, u), $i(T, f, g);
  const a = await Ve(u, g, o, i2, T, e2);
  await Vi(n, a), await ji(t, a), Xe(T, a), oP(void 0, s, Ft("padding"), Ft("useMaxWidth"));
}, "draw");
var Zi = { draw: Ki };
var rr = {
  parser: Bi,
...
//# sourceMappingURL=architectureDiagram-SUXI7LT5-CpWQYJus-DReApCvq-LNFNVFNZ.js.map
