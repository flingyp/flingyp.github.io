...
// node_modules/.pnpm/vitepress-plugin-legend@1.0.4_jiti@1.21.7_markmap-common@0.18.9_typescript@5.4.3_yaml@2.8.0/node_modules/vitepress-plugin-legend/dist/journeyDiagram-EWQZEKCU-WWIdK_St-Deg5yU4v.js
var X = function() {
  var t = S(function(d2, i, a, u) {
    ...
    performAction: S(function(d2, i, a, u, p, o2, x) {
      var k = o2.length - 1;
      switch (p) {
        case 1:
          return o2[k - 1];
    ...
    parse: S(function(d2) {
      var i = this, a = [0], u = [], p = [null], o2 = [], x = this.table, k = "", T = 0, A = 0, ut = 2, K = 1, pt = o2.slice.call(arguments, 1), b = Object.create(this.lexer), I = { yy: {} };
      ...
      function Z() {
        var w;
        return w = u.pop() || b.lex() || K, typeof w != "number" && (w instanceof Array && (u = w, w = u.pop()), w = i.symbols_[w] || w), w;
      }
      S(Z, "lex");
      for (var _, P, $, W, j = {}, D, M, J, O; ; ) {
        if (P = a[a.length - 1], this.defaultActions[P] ? $ = this.defaultActions[P] : ((_ === null || typeof _ > "u") && (_ = Z()), $ = x[P] && x[P][_]), typeof $ > "u" || !$.length || !$[0]) {
          var G = "";
          O = [];
          for (D in x[P])
...
` + b.showPosition() + `
Expecting ` + O.join(", ") + ", got '" + (this.terminals_[_] || _) + "'" : G = "Parse error on line " + (T + 1) + ": Unexpected " + (_ == K ? "end of input" : "'" + (this.terminals_[_] || _) + "'"), this.parseError(G, {
            text: b.match,
        ...
        switch ($[0]) {
          ...
          case 2:
            if (M = this.productions_[$[1]][1], j.$ = p[p.length - M], j._$ = {
              ...
              return W;
            M && (a = a.slice(0, -1 * M * 2), p = p.slice(0, -1 * M), o2 = o2.slice(0, -1 * M)), a.push(this.productions_[$[1]][0]), p.push(j.$), o2.push(j._$), J = x[a[a.length - 2]][a[a.length - 1]], a.push(J);
            break;
          case 3:
            return true;
        }
...
` + this.showPosition(), {
      ...
      performAction: S(function(i, a, u, p) {
        switch (u) {
          case 0:
            break;
          case 1:
  ...
  return S(g2, "Parser"), g2.prototype = f, f.Parser = g2, new g2();
}();
X.parser = X;
var Ct = X;
var V = "";
...
var R = [];
var Et = S(function() {
  q.length = 0, L.length = 0, V = "", R.length = 0, hP();
}, "clear");
var Tt = S(function(t) {
  V = t, q.push(t);
}, "addSection");
...
var it = {
  getConfig: S(() => me().journey, "getConfig"),
  clear: Et,
  setDiagramTitle: mP,
  getDiagramTitle: gP,
  setAccTitle: uP,
...
var Ft = S(function(t, e) {
  ...
  return S(c, "ambivalent"), e.score > 3 ? n(l2) : e.score < 3 ? y(l2) : c(l2), r;
}, "drawFace");
var ot = S(function(t, e) {
...
var lt = S(function(t, e) {
  return d(t, e);
}, "drawText");
var Dt = S(function(t, e) {
...
var Ot = S(function(t, e, r) {
  const l2 = t.append("g"), n = g();
  n.x = e.x, n.y = e.y, n.fill = e.fill, n.width = r.width * e.taskCount + // width of the tasks
  r.diagramMarginX * (e.taskCount - 1), n.height = r.height, n.class = "journey-section section-type-" + e.num, n.rx = 3, n.ry = 3, H(l2, n), ct(r)(
    e.text,
    l2,
    n.x,
    n.y,
...
var Nt = S(function(t, e, r) {
  ...
  const c = g();
  c.x = e.x, c.y = e.y, c.fill = e.fill, c.width = r.width, c.height = r.height, c.class = "task task-type-" + e.num, c.rx = 3, c.ry = 3, H(n, c);
  let h2 = e.x + 14;
  e.people.forEach((f) => {
...
var ct = function() {
  ...
  return S(l2, "_setTextAttrs"), function(n) {
...
var N = 0;
function ht(t) {
  const e = me().journey, r = e.maxLabelWidth;
  N = 0;
  let l2 = 60;
...
var S2 = me().journey;
var E = 0;
var Gt = S(function(t, e, r, l2) {
  const n = me(), y = n.journey.titleColor, c = n.journey.titleFontSize, h2 = n.journey.titleFontFamily, f = n.securityLevel;
  let m;
  f === "sandbox" && (m = ae("#i" + e));
  ...
  }), ht(d2), E = S2.leftMargin + N, v.insert(0, 0, E, Object.keys(C).length * 50), Ut(d2, i, 0);
  ...
  const x = o2.stopy - o2.starty + 2 * S2.diagramMarginY, k = E + o2.stopx + 2 * S2.diagramMarginX;
  hw(d2, x, k, S2.useMaxWidth), d2.append("line").attr("x1", E).attr("y1", S2.height * 4).attr("x2", k - E - 4).attr("y2", S2.height * 4).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)");
  const T = a ? 70 : 0;
...
var v = {
  ...
  updateVal: S(function(t, e, r, l2) {
    t[e] === void 0 ? t[e] = r : t[e] = l2(r, t[e]);
  }, "updateVal"),
  updateBounds: S(function(t, e, r, l2) {
    const n = me().journey, y = this;
    let c = 0;
    function h2(f) {
      return S(function(m) {
        c++;
    ...
    S(h2, "updateFn"), this.sequenceItems.forEach(h2());
  }, "updateBounds"),
  insert: S(function(t, e, r, l2) {
...
var Q = S2.sectionFills;
var st = S2.sectionColours;
var Ut = S(function(t, e, r) {
  const l2 = me().journey;
  let n = "";
  ...
  for (const [d2, i] of e.entries()) {
    if (n !== i.section) {
      f = Q[h2 % Q.length], g2 = h2 % Q.length, m = st[h2 % st.length];
      let u = 0;
      const p = i.section;
    ...
    i.x = d2 * l2.taskMargin + d2 * l2.width + E, i.y = c, i.width = l2.diagramMarginX, i.height = l2.diagramMarginY, i.colour = m, i.fill = f, i.num = g2, i.actors = a, F.drawTask(t, i, l2), v.insert(i.x, i.y, i.x + i.width + l2.taskMargin, 300 + 5 * 30);
  }
}, "drawTasks");
var at = {
  setConf: Wt,
...
//# sourceMappingURL=journeyDiagram-EWQZEKCU-WWIdK_St-Deg5yU4v-CLHXNQ72.js.map
